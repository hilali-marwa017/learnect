...
/* Cette configuration permet de définir les routes de l’application (web et API), d’activer Sanctum pour la sécurité des API, et de créer un middleware de rôle pour contrôler l’accès des utilisateurs */
