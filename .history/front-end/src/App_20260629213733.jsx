...
// ✅ CORRIGÉ : import depuis teacher/ pas public/
...
import TeacherDemandes from './pages/teacher/Demandes.jsx'; 
  ...
  return (
    <Routes>
      ...
      <Route path="/teacher" element={<Layout />}>
        ...
        <Route path="demandes" element={<ProtectedRoute allowedRole="enseignant"><TeacherDemandes /></ProtectedRoute>} />
