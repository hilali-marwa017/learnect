  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<Layout />}>
        ...
        {/* ⭐ Route Notifications générale (redirige vers la bonne page) */}
        <Route path="notifications" element={
          <ProtectedRoute>
            {({ user }) => {
              if (user?.role === 'enseignant') return <Navigate to="/teacher/notifications" replace />;
              if (user?.role === 'etudiant') return <Navigate to="/student/notifications" replace />;
