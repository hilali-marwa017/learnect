  ...
  if (step === 'success') return (
    <div style={overlayStyle}>
      <div style={{ ...modalStyle, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', padding: '3rem 2rem' }}>
        ...
        <p style={{ fontSize: '0.78rem', color: muted, margin: 0, textAlign: 'center' }}>En attente de validation par le professeur.</p>
      </div>
    </div>
  );
      ...
      <div style={modalStyle}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '1.5rem' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.72rem', color: muted }}>Montant à régler : {montant} DH</div>
          </div>
        </div>
