        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-16">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs text-ash">
              <li><button onClick={() => onSectionScroll('tutors-section')} className="hover:text-accent-blue cursor-pointer">Mathématiques</button></li>
              <li><button onClick={() => onSectionScroll('tutors-section')} className="hover:text-accent-blue cursor-pointer">Anglais & TOEFL</button></li>
              <li><button onClick={() => onSectionScroll('tutors-section')} className="hover:text-accent-blue cursor-pointer">Programmation & Code</button></li>
            </ul>
          </div>
