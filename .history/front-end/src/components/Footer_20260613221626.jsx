      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <div className="flex gap-3">
            {[Heart, Share2, Star, Globe].map(function(Icon, i) {
              return (
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><span onClick={function() { scrollToSection('tutors-section'); }} className="text-gray-400 text-sm cursor-pointer hover:text-[#e04f00] transition">Nos professeurs</span></li>
            <li><span onClick={function() { scrollToSection('how-it-works'); }} className="text-gray-400 text-sm cursor-pointer hover:text-[#e04f00] transition">Comment ça marche</span></li>
            <li><span onClick={function() { scrollToSection('faq-section'); }} className="text-gray-400 text-sm cursor-pointer hover:text-[#e04f00] transition">FAQ</span></li>
