...
export default function Footer({ isDark }) {
  ...
  // Fond noir par défaut, s'adapte au thème
    ...
    <footer style={{ background: bg, borderTop: `1px solid ${border}`, padding: '3rem 2rem 1.5rem' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{
          ...
          {/* Explorer (anciennement Navigation) */}
          <div>
        ...
        <div style={{ borderTop: `1px solid ${border}`, paddingTop: '1.5rem', textAlign: 'center' }}>
          <p style={{ fontSize: '0.7rem', color: textMuted }}>
            © {currentYear} Learnect.ma — Tous droits réservés.
          </p>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', marginTop: '0.5rem' }}>
            <Link to="/conditions" style={{ fontSize: '0.65rem', color: textMuted, textDecoration: 'none', transition: 'color 0.2s' }}
              onMouseEnter={function(e) { e.currentTarget.style.color = orange; }}
              onMouseLeave={function(e) { e.currentTarget.style.color = textMuted; }}>
              CGU
            </Link>
            <Link to="/confidentialite" style={{ fontSize: '0.65rem', color: textMuted, textDecoration: 'none', transition: 'color 0.2s' }}
              onMouseEnter={function(e) { e.currentTarget.style.color = orange; }}
              onMouseLeave={function(e) { e.currentTarget.style.color = textMuted; }}>
              Confidentialité
            </Link>
            <Link to="/mentions-legales" style={{ fontSize: '0.65rem', color: textMuted, textDecoration: 'none', transition: 'color 0.2s' }}
              onMouseEnter={function(e) { e.currentTarget.style.color = orange; }}
              onMouseLeave={function(e) { e.currentTarget.style.color = textMuted; }}>
              Mentions légales
            </Link>
