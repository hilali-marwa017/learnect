...
// fonction pure: obtenir les initiales
...
// fonction pure: obtenir l'url de la photo
...
// fonction pure: verifier si user est connecte
const isLoggedIn = (user) => !!user;

// fonction pure: verifier si user est admin
const isAdmin = (user) => user?.role === 'admin';

// fonction pure: obtenir le nombre de notifications non lues
const getUnreadCount = (notifications) => {
  return (notifications || []).filter(n => !n.est_lue).length;
};

// fonction pure: obtenir la route de navigation
...
// ====== COMPOSANT AVATAR (DAIF architecture) ======
...
// ====== COMPOSANT BOUTON THEME (DAIF architecture) ======
...
// ====== COMPOSANT NOTIFICATIONS (DAIF architecture) ======
...
// ====== COMPOSANT PROFIL DROPDOWN (DAIF architecture) ======
...
// ====== COMPOSANT BOUTONS AUTH (DAIF architecture) ======
...
// ====== COMPOSANT MOBILE MENU (DAIF architecture) ======
...
// ====== COMPOSANT PRINCIPAL (DAIF architecture) ======
