...
export default function PaymentSimulationModal({ 
  ...
  // ✅ FIX : Convertir montant en nombre une fois pour toutes
      ...
      <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '0.75rem', color: muted, margin: '2px 0 0' }}>
                {/* ✅ Utilisation de montantNum */}
                {montantNum > 0 ? montantNum.toFixed(2) + ' DH' : 'Cours gratuit'}
              </p>
            </div>
          </div>
        ...
        {step === 'form' && (
          <form onSubmit={handleSubmit}>
            ...
            >
              {/* ✅ Utilisation de montantNum */}
              CONFIRMER LE PAIEMENT {montantNum > 0 ? '— ' + montantNum.toFixed(2) + ' DH' : ''}
            </button>
