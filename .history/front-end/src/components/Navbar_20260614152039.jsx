                ...
                <div style={{ position: 'relative' }}>
                  ...
                  {isProfileOpen && (
                    <div style={{ 
                      ...
                      <button onClick={() => { navigate('/profile'); setIsProfileOpen(false); }} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '10px 12px', width: '100%', background: 'none', border: 'none', cursor: 'pointer', color: isDark ? '#ffffff' : '#07090d', textAlign: 'left', borderRadius: '8px' }}>
                        <User size={16} /> Mon profil
                      </button>
                      <button onClick={() => { navigate('/dashboard'); setIsProfileOpen(false); }} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '10px 12px', width: '100%', background: 'none', border: 'none', cursor: 'pointer', color: isDark ? '#ffffff' : '#07090d', textAlign: 'left', borderRadius: '8px' }}>
                        Tableau de bord
                      </button>
      ...
      {isOpen && (
        <div style={{ 
          ...
          {isLoggedIn ? (
            ...
            <>
              <button onClick={() => { navigate('/login'); setIsOpen(false); }} style={{ padding: '10px', cursor: 'pointer', color: isDark ? '#ffffff' : '#1f2937', textAlign: 'center', border: `1px solid ${isDark ? 'rgba(255,255,255,0.3)' : '#d1d5db'}`, borderRadius: '8px', marginBottom: '4px' }}>Connexion</button>
