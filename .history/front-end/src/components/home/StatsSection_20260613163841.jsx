  ...
  useEffect(function() {
    ...
    api.get('/enseignants')
      .then(function(response) {
        ...
        // Compter les étudiants depuis les données des enseignants ? Non, autre méthode
        // On utilise une valeur par défaut
        setStats(function(prev) {
          return { ...prev, totalEtudiants: 125 };
        });
      })
      .catch(function(err) {
    ...
    api.get('/matieres')
      .then(function(response) {
        var totalMatieres = response.data.length;
        setStats(function(prev) {
          return { ...prev, totalMatieres: totalMatieres };
        });
      })
      .catch(function(err) {
