...
import { Shield, Scale, Send, FileText, Users, CheckCircle } from 'lucide-react';
...
export default function FeaturesSection({ isDark }) {
  ...
  const features = [
    ...
    { icon: Send, title: 'Publier une demande', desc: 'Vous cherchez un professeur ? Publiez votre annonce et recevez des propositions de tuteurs qualifiés.', color: orange }
  ];
  ...
  return (
    <section style={{ background: bg, padding: '4rem 2rem' }}>
      <div style={{ maxWidth: 1000, margin: '0 auto', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: '2rem', fontWeight: 800, color: textColor, marginBottom: '2rem' }}>
