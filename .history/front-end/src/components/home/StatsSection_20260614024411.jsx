        ...
        {stats.map(function(stat, i) {
          ...
          return (
            <div key={i} style={{ textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '1.8rem', fontWeight: 'bold', color: textColor, lineHeight: 1.2 }}>{stat.value}</div>
              <div style={{ fontSize: '0.7rem', color: textMuted, letterSpacing: '0.05em', marginTop: '0.25rem' }}>{stat.label}</div>
            </div>
          );
        })}
      </div>
