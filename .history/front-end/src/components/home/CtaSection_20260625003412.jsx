      ...
      <div className="cta-wrap" style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '2rem' }}>
        ...
        <div style={{ flex: 1, minWidth: '220px', textAlign: 'right' }}>
          <button
            ...
            onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 10px 26px rgba(224,79,0,0.45)'; }}
            onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 6px 20px rgba(224,79,0,0.35)'; }}
          >
            <FileText size={16} />
            {user ? 'Mes demandes' : 'Publier une demande'}
            <ArrowRight size={16} />
          </button>
          <p style={{ fontSize: '0.7rem', color: muted, marginTop: '10px' }}>
