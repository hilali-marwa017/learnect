  ...
  return (
    <section style={{ background: bg, padding: '5rem 2rem 4rem', textAlign: 'center' }}>
      ...
      <div style={{
        ...
        maxWidth: 680,
        margin: '0 auto',
        boxShadow: isDark ? '0 0 0 1px rgba(255,255,255,0.04)' : '0 2px 12px rgba(0,0,0,0.06)'
      }}>
        ...
        {/* Separateur vertical */}
        <div style={{ width: 1, height: 32, background: separator }} />
