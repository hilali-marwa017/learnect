  ...
  return (
    <section style={{ background: bg, padding: '4rem 2rem', textAlign: 'center', borderBottom: `1px solid ${border}` }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        <span style={{ fontSize: '0.65rem', letterSpacing: '0.2em', fontWeight: 700, textTransform: 'uppercase', color: '#e04f00' }}>MÉTHODOLOGIE</span>
        <h2 style={{ fontSize: '2rem', fontWeight: 700, color: text, marginTop: '0.5rem' }}>Comment fonctionne Learnect ?</h2>
