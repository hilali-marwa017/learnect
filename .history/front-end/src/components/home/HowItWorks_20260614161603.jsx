    ...
    <section style={{ background: bg, padding: '4rem 2rem', borderBottom: `1px solid ${border}` }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '2rem', textAlign: 'left' }}>
          ...
          <p style={{ color: muted, margin: '0.5rem 0 0 0' }}>Une mise en relation simple, rapide et sécurisée.</p>
        </div>
        {/* Contenu centré */}
        <div className="hiw-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem', textAlign: 'center' }}>
          {steps.map((step, i) => {
