...
import { Search, MapPin, BookOpen, Calculator, Languages, TrendingUp, Scale, RefreshCw, Wifi, Home } from 'lucide-react';
  ...
  return (
    <section style={{ 
      ...
      <div style={{ 
        ...
        {/* Div 2: Ville - avec icône En ligne */}
        <div style={{ 
          flex: 1, 
          position: 'relative',
          background: isDark ? '#1a1a1c' : '#ffffff',
          ...
          {showCityDrop && !loading && getFilteredCities().length > 0 && (
            <div style={{ 
              ...
              {/* Option En ligne en premier */}
              <div 
                onMouseDown={() => onSelectCity('En ligne')} 
                style={{ 
                  padding: '12px 20px', 
                  cursor: 'pointer', 
                  display: 'flex', 
                ...
                onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}
              >
                <Wifi size={16} color={orange} /> <span>En ligne</span>
              </div>
              {/* Les autres villes */}
