...
import TeacherCard from './TeacherCard';  // ✅ Correction du chemin
import api from '../../api/axios';          // ✅ Correction du chemin
      ...
      {teachers.length === 0 ? (
        ...
        <div style={{ 
          ...
          {teachers.map(teacher => (
            <TeacherCard key={teacher.id || teacher.utilisateur_id} teacher={teacher} isDark={isDark} />
          ))}
        </div>
      )}
    </section>
