...
export default function HeroSection({ isDark, querySubject, setQuerySubject, queryCity, setQueryCity, activePill, setActivePill }) {
  ...
  return React.createElement('section', { style: { background: bg, padding: '6rem 2rem 4rem', textAlign: 'center' } },
    React.createElement('h1', { style: { fontFamily: '"EB Garamond", Georgia, serif', fontSize: 'clamp(2.8rem, 7vw, 5rem)', fontWeight: 700, color: textColor, lineHeight: 1.1, letterSpacing: '-0.02em', maxWidth: 750, margin: '0 auto 1rem' } }, 'Trouvez le professeur parfait'),
    React.createElement('p', { style: { fontSize: '1rem', color: textMuted, maxWidth: 580, margin: '0 auto 2rem', lineHeight: 1.7 } }, 'Soutien scolaire certifié, méthodologique et sur-mesure pour les étudiants marocains. Premier cours offert par nos tuteurs.'),
