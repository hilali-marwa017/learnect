    ...
    <section style={{
      ...
      <div className="container">
        ...
        <div style={{
          ...
          🔥 Plus de 10 000 cours donnés | 98% de satisfaction
        </div>
        ...
        <h1 style={{
          ...
          Le <span className="text-primary">cours particulier</span> qui<br />
          transforme votre avenir
        </h1>
        ...
        <h2 style={{
          ...
          Excel, Réussite, Confiance — À votre rythme
        </h2>

        {/* Description */}
        <p style={{
          color: '#64748B', fontSize: '1rem',
          maxWidth: 550, margin: '0 auto 2.5rem', lineHeight: 1.6,
        }}>
          Des professeurs qualifiés, une pédagogie sur-mesure.
          <strong className="text-primary"> 1er cours offert</strong> pour chaque nouvelle matière.
        </p>
