...
export default function TeacherCard({ teacher, user }) {
  ...
  // ✅ CORRECTION : utiliser directement teacher.utilisateur_id et teacher.user
  ...
  // ✅ CORRECTION : photo
  const photo = teacher.user?.photo || teacher.photo;
  ...
  const ville = teacher.user?.ville || teacher.ville || '';
  const noteMoyenne = teacher.noteMoyenne || 0;
