...
export default function FaqSection() {
  ...
  var faqs = [
    ...
    },
    {
      ...
      answer: "Oui, vous êtes entièrement libre de changer de professeur à tout moment si vous estimez que la pédagogie ou les horaires ne correspondent plus à vos besoins."
    }
  ];
