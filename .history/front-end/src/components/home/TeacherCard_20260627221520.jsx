...
export default function TeacherCard({ teacher, user }) {
  ...
  return (
    ...
    >
      ...
      {teacher.isFirstFree && (
        <div style={{ position: 'absolute', top: '14px', left: '14px', zIndex: 2, display: 'flex', alignItems: 'center', gap: '6px', background: 'linear-gradient(135deg, #4e4e4e, #047857)', color: '#fff', fontSize: '0.65rem', fontWeight: 700, padding: '5px 12px', borderRadius: '999px', boxShadow: '0 2px 8px rgba(4,120,87,0.45)', letterSpacing: '0.03em' }}>
