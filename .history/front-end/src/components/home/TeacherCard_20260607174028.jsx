...
function TeacherCard({ teacher, user, onSelect }) {
  ...
  // Récupérer le nom de la matière (première matière)
    ...
    >
      ...
      <div style={{ padding: '12px', textAlign: 'left' }}>
        ...
        <p style={{
          ...
          <strong style={{ color: '#0F172A' }}>{matiereNom}</strong> — {teacher.titre || teacher.description_profil || 'Professeur expérimenté'}
        </p>
