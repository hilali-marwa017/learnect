  ...
  return (
    <div style={{ background: bg, padding: '3rem 2rem', borderTop: `1px solid ${border}`, borderBottom: `1px solid ${border}` }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto', textAlign: 'center', marginBottom: '2rem' }}>
        <h2 style={{ fontSize: '1.8rem', fontWeight: 700, color: text }}>Learnect en quelques chiffres</h2>
      </div>
      <div className="stats-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', maxWidth: '1000px', margin: '0 auto' }}>
        {stats.map((s, i) => {
          const Icon = s.icon;
          return (
