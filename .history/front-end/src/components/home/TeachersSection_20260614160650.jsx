    ...
    <section id="tutors-section" style={{ background: bg, padding: '3rem 2rem' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '2rem' }}>
          <span style={{ fontSize: '0.65rem', letterSpacing: '0.2em', fontWeight: 700, textTransform: 'uppercase', color: orange }}>NOS ENSEIGNANTS</span>
          <h2 style={{ fontSize: '1.8rem', fontWeight: 700, color: text, margin: '0.25rem 0 0.25rem', textAlign: 'left' }}>
            Les profs de la semaine
          </h2>
          <p style={{ color: muted, textAlign: 'left', margin: 0 }}>
            Nos meilleurs enseignants accrédités partout au Maroc.
          </p>
        </div>
