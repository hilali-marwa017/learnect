...
export default function TeacherCard({ teacher, isDark, user }) {
  ...
  function handleContact(e) {
    ...
    if (role === 'etudiant') {
      // étudiant → ses messages
      navigate('/student/messages');
    } else if (role === 'enseignant') {
      // enseignant ne peut pas contacter un autre enseignant
  ...
  return (
    ...
    >
      {/* Background image — couleurs naturelles */}
      <img
        src={teacher.avatar}
        alt={teacher.name}
        style={{
          width: '100%', height: '100%', objectFit: 'cover',
          objectPosition: 'top center', position: 'absolute', top: 0, left: 0,
        }}
      />
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <button
            ...
            style={{
              ...
              cursor: 'pointer', boxShadow: '0 2px 10px rgba(224,79,0,0.4)',
