...
export default function FaqSection({ isDark }) {
  ...
  return (
    <section style={{ background: bg, padding: '4.5rem 2rem', borderTop: `1px solid ${border}` }}>
      <div style={{ maxWidth: 700, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          <span style={{ fontSize: '0.65rem', letterSpacing: '0.2em', fontWeight: 700, textTransform: 'uppercase', color: blue }}>
            QUESTIONS FRÉQUENTES
          </span>
          <h2 style={{ fontSize: 'clamp(1.6rem, 4vw, 2.6rem)', fontWeight: 800, color: textColor, margin: '0.6rem 0 0.75rem', letterSpacing: '-0.015em' }}>
              ...
              <div key={i} style={{
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    <HelpCircle size={16} color={orange} />
                    <span style={{ fontWeight: 600, color: textColor, fontSize: '0.87rem', textAlign: 'left' }}>
                      {faq.q}
                    </span>
                  </div>
                  <ChevronDown
                ...
                {isOpen && (
                  <div style={{
                    ...
                    fontSize: '0.82rem', color: textMuted, lineHeight: 1.75
                  }}>
                    {faq.a}
                  </div>
                )}
