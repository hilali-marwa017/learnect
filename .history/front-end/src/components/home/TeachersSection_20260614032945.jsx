  ...
  if (filteredTutors.length === 0) {
    return (
      <section className='text-center' id="tutors-section" style={{ background: bgColor, padding: '3rem 2rem' }}>
        ...
        <button className='text-center' onClick={onReset} style={{ marginTop: '1rem', padding: '0.5rem 1.5rem', background: orange, color: '#fff', border: 'none', borderRadius: 8, cursor: 'pointer' }}>Réinitialiser</button>
      </section>
    );
  }
