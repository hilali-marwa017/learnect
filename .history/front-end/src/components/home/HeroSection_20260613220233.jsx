...
export default function HeroSection({
  ...
  return (
    <section style={{ padding: '5rem 2rem', textAlign: 'center' }}>
      ...
      {/* Search bar - 2 inputs égaux en largeur */}
      <div style={{
        display: 'flex',
        flexDirection: 'row',
        alignItems: 'stretch',
          ...
          <div style={{
            ...
            {querySubject && (
              <X
                ...
                onClick={function() { setQuerySubject(''); }}
              />
            )}
          </div>
      ...
      {/* Pills - Top matières avec scroll vers section */}
      ...
      {loading && (
        <div style={{ marginTop: '1rem' }}>
          <span style={{ fontSize: '0.7rem', color: mute }}>Chargement des matières...</span>
        </div>
      )}
    </section>
  );
