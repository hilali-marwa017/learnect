...
export default function HeroSection({ isDark, querySubject, setQuerySubject, queryCity, setQueryCity, activePill, setActivePill }) {
  ...
  // ✅ Fonction scroll vers la section des profs
  ...
  // ✅ Fonction qui gère la sélection + scroll
  ...
  // ✅ Fonction qui gère le changement de matière avec scroll
  ...
  // ✅ Fonction qui gère le changement de ville avec scroll
  ...
  return (
    <section style={{ background: isDark ? '#000000' : '#f8f9fc', padding: '4rem 2rem', textAlign: 'center' }}>
      ...
      {/* Barre de recherche */}
      <div className="search-bar-wrapper" style={{ display: 'flex', alignItems: 'center', background: isDark ? '#1a1a1c' : '#ffffff', borderRadius: '50px', padding: '4px', maxWidth: '850px', margin: '0 auto', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
        
        {/* Input Matière */}
        <div style={{ flex: 1, position: 'relative', background: isDark ? '#1a1a1c' : '#ffffff', borderRadius: '50px', minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '16px 20px' }}>
            <Search size={20} color={isDark ? '#6b7280' : '#9ca3af'} style={{ flexShrink: 0 }} />
            <input
              value={querySubject}
              ...
              style={{ flex: 1, background: 'transparent', border: 'none', outline: 'none', color: isDark ? '#ffffff' : '#07090d', fontSize: '0.95rem', minWidth: 0 }}
            />
          </div>
        ...
        <div style={{ flex: 1, position: 'relative', background: isDark ? '#1a1a1c' : '#ffffff', borderRadius: '50px', minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '16px 20px' }}>
            <MapPin size={20} color={isDark ? '#6b7280' : '#9ca3af'} style={{ flexShrink: 0 }} />
            <input
              value={queryCity}
        ...
        <button onClick={() => {
          scrollToTeachers();
          // Si la barre de recherche est vide, on scroll quand même
        }} style={{ background: '#e04f00', color: '#fff', border: 'none', borderRadius: '50px', padding: '14px 32px', fontWeight: 600, fontSize: '0.95rem', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px', marginRight: '4px', flexShrink: 0 }}>
          <Search size={18} /> <span className="search-btn-label">Rechercher</span>
        </button>
      </div>
            ...
            return (
              <button 
                ...
                style={{ 
                  ...
                  fontSize: '0.85rem', 
                  cursor: 'pointer', 
                  border: `1px solid ${isActive ? '#e04f00' : pillBorder}`, 
