  ...
  return (
    ...
    >
      <img
        ...
        onError={(e) => {
          e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(nomComplet)}&background=e04f00&color=fff`;
        }}
      />
