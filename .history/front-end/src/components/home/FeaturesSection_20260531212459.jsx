          ...
          <div className="col-md-5">
            <div style={{
              ...
              <p style={{
                ...
                La sécurité est notre priorité. L'administrateur vérifie
                rigoureusement chaque diplôme supérieur et pièces d'identité
                des professeurs avant mise en ligne.
              </p>
              <div style={{
