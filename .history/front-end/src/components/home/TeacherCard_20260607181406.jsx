...
function TeacherCard({ teacher, user }) {
  ...
  // Correction pour noteMoyenne (convertir en nombre si c'est une string)
  const noteMoyenne = typeof teacher.noteMoyenne === 'string' 
    ? parseFloat(teacher.noteMoyenne) 
    : teacher.noteMoyenne || 5.0;

  const tarif = typeof teacher.tarifHeure === 'string' 
    ? parseFloat(teacher.tarifHeure) 
    : teacher.tarifHeure || 0;
