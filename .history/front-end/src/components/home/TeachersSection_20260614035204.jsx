...
export default function TeachersSection({ isDark, tutors = [], loading = false, error = '', onReset, querySubject, queryCity }) {
  ...
  if (!tutors || tutors.length === 0) {
    return (
      <section id="tutors-section" style={{ background: bgColor, padding: '3rem 2rem', textAlign: 'center' }}>
        <p style={{ color: textMuted }}>Aucun professeur trouvé</p>
    ...
    <section id="tutors-section" style={{ background: bgColor, padding: '3rem 2rem' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ marginBottom: '1.5rem' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: 700, color: textColor, textAlign: 'left' }}>Les profs de la semaine</h2>
