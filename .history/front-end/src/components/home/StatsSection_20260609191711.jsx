          ...
          {stats.map(function(s, i) {
            return (
              <div key={i} className="col-6 col-md-3">
                <div style={{ textAlign: 'center', padding: '1.2rem', borderRadius: 12, border: '1px solid #F1F5F9' }}>
                  <i className={`bi ${s.icon}`} style={{ fontSize: '1.4rem', color: '#0d6efd', marginBottom: 6, display: 'block' }} />
                  <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '1.6rem', fontWeight: 900, color: '#0F172A', lineHeight: 1 }}>
                    {s.num}
                  </div>
