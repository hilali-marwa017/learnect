...
function TeacherCard({ teacher, user }) {
  ...
  // Sécurité : si pas de données, on n'affiche rien
  if (!teacher || !user) {
    return null;
  }
  ...
  // Conversion SÉCURISÉE de la note (évite l'erreur toFixed)
  let noteMoyenne = 5.0; // valeur par défaut
  ...
  // Formatage de la note (1 décimale)
