...
import { Star, GraduationCap, Users, BookOpen } from 'lucide-react';
import api from '../../api/axios';

export default function StatsSection() {
  const [stats, setStats] = useState(null);

  // GET /api/admin/stats — route admin, fallback si non connecté
  useEffect(() => {
    api.get('/admin/stats')
  ...
  const items = [
    ...
    { label: 'Réservations', value: stats?.total_reservations ?? '...', icon: BookOpen, color: 'text-accent-green' },
