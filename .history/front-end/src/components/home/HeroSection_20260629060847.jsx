// ============================================================
// HeroSection.jsx — FIX : Scroll moins agressif vers la gauche
// ============================================================
...
export default function HeroSection({
  ...
  // --- FIX : Scroll plus doux, pas de décalage horizontal ---
  function scrollToTeachers() {
    const element = document.getElementById('tutors-section');
    if (!element) return;
    
    // ✅ scrollIntoView au lieu de scrollTo — pas de décalage horizontal
