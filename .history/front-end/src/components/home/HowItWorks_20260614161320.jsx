    ...
    <section style={{ background: bg, padding: '4rem 2rem', borderBottom: `1px solid ${border}` }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ marginBottom: '2rem' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: text, margin: 0, textAlign: 'left' }}>Comment fonctionne Learnect ?</h2>
          <p style={{ color: muted, margin: '0.5rem 0 0 0', textAlign: 'left' }}>Une mise en relation simple, rapide et sécurisée.</p>
        </div>
