...
export default function Navbar({ isDark, onToggleTheme, user, onLogout }) {
  ...
  const navLinks = [
    { label: 'Trouver un Prof', action: () => { document.getElementById('tutors-section')?.scrollIntoView({ behavior: 'smooth' }); } },
    { label: 'Comment ça marche', action: () => { document.getElementById('how-it-works')?.scrollIntoView({ behavior: 'smooth' }); } },
    { label: 'Qualité certifiée', action: () => { document.getElementById('features-section')?.scrollIntoView({ behavior: 'smooth' }); } },
  ];
