    ...
    <footer style={{ background: bg, borderTop: `1px solid ${border}`, padding: '3rem 2rem 1.5rem' }}>
      <div className="footer-grid" style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '2rem', marginBottom: '2rem' }}>
        ...
        <div>
          ...
          <ul style={{ listStyle: 'none', padding: 0 }}>
            <li style={{ marginBottom: '0.5rem', fontSize: '0.75rem', color: muted }}><Link to="/conditions">Conditions</Link></li>
            <li style={{ marginBottom: '0.5rem', fontSize: '0.75rem', color: muted }}><Link to="/confidentialite">Confidentialité</Link></li>
            <li style={{ marginBottom: '0.5rem', fontSize: '0.75rem', color: muted }}><Link to="/mentions-legales">Mentions légales</Link></li>
          </ul>
        </div>
        <div>
