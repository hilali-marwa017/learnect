  ...
  if (step === 'success') return (
    <div style={overlayStyle}>
      <div style={{ ...modalStyle, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.25rem', padding: '3rem 2rem', textAlign: 'center' }}>
        ...
        <div>
          <p style={{ fontSize: '0.95rem', color: text, fontWeight: 800, margin: '0 0 8px' }}>RÉSERVATION & PAIEMENT CONFIRMÉS</p>
        ...
        <button onClick={handleOk} style={{ width: '100%', background: '#e04f00', color: '#fff', border: 'none', borderRadius: '12px', padding: '14px', fontWeight: 800, fontSize: '0.88rem', cursor: 'pointer', fontFamily: 'monospace', letterSpacing: '0.06em', textTransform: 'uppercase' }}>
          OK
        </button>
      </div>
    </div>
