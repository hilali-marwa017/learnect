      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 40, marginBottom: 40 }}>
          ...
          <div>
            ...
            <div className='' style={{ background: '#0000001a',border: '1px solid #0d6efd33',borderRadius: 10,padding: '8px 12px',fontSize: '0.68rem',fontWeight: 700,color: '#60a5fa', marginTop: 12, display: 'flex', alignItems: 'center', gap: 6}}>
