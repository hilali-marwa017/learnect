      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4">
            <h3 className="text-xl font-black text-canvas tracking-tight">Learn<span className="text-accent-orange">ect</span></h3>
            <p className="text-sm leading-relaxed">Soutien scolaire certifié et méthodologique pour les étudiants marocains. Trouvez le professeur parfait près de chez vous.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2"><Mail className="h-4 w-4 text-accent-orange" /> contact@learnect.ma</li>
              <li className="flex items-center gap-2"><Phone className="h-4 w-4 text-accent-orange" /> +212 5XX-XXXXXX</li>
              <li className="flex items-center gap-2"><MapPin className="h-4 w-4 text-accent-orange" /> Casablanca, Maroc</li>
            </ul>
          </div>
        </div>
