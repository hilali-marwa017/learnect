...
export default function PaymentSimulationModal({ open, onClose, onConfirmed, montant, methode, isDark }) {
  ...
  if (step === 'processing') return (
    <div style={overlayStyle}>
      <div style={{ ...modalStyle, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '1rem', padding: '3rem 2rem' }}>
  ...
  return (
    <div style={overlayStyle}>
      <div style={modalStyle}>
        ...
        <button
          onClick={onClose}
          style={{ position: 'absolute', top: '1rem', right: '1rem', background: 'none', border: 'none', cursor: 'pointer', color: muted, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
        >
          <X size={18} />
        </button>
