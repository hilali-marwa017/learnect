    ...
    <div>
      ...
      {isOpen && (
        <div style={{ 
          ...
          <button onClick={onToggleTheme} style={{ background: isDark ? '#5a5a5c' : '#f1f3f5', borderRadius: '8px', padding: '10px', cursor: 'pointer', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
