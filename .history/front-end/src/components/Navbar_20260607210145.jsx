        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
          ...
          {isAuthenticated ? (
            <>
              ...
              <button className='btn btn-outline-danger' onClick={handleLogout} disabled={isLoggingOut}  isLoggingOut ? 'not-allowed' : 'pointer', opacity: isLoggingOut ? 0.7 : 1, display: 'flex', alignItems: 'center', gap: 8 }}>
                {isLoggingOut ? (
