        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
          ...
          {isAuthenticated ? (
            <>
              ...
              <button onClick={handleLogout} disabled={isLoggingOut} style={{ color: 'white', border: 'none', borderRadius: 10, fontSize: 14, padding: '9px 18px', fontWeight: 600, cursor: isLoggingOut ? 'not-allowed' : 'pointer', opacity: isLoggingOut ? 0.7 : 1, display: 'flex', alignItems: 'center', gap: 8 }}>
                {isLoggingOut ? (
