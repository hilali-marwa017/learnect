  ...
  useEffect(() => {
    async function fetchDemandes() {
      try {
        ...
        // ✅ FILTRE : exclure les demandes "test" et "TEST"
                ...
                {activeDemande && (
                  <div style={{ background: bgCard, border: '1px solid ' + border, borderRadius: '20px', padding: '1.5rem' }}>
                    ...
                    {!activeDemande.offres ? (
                      ...
                      (() => {
                        // ✅ FILTRE : exclure les offres avec des messages de test
                        const offresValides = (activeDemande.offres || []).filter(o => {
                          const msg = o.message?.toLowerCase() || '';
                          return !msg.includes('test') && o.enseignant && o.enseignant.user && o.enseignant.user.prenom;
                        });
                              ...
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem' }}>
                                <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                                  ...
                                  <div>
                                    ...
                                    {ensId && (
                                      <button onClick={() => navigate('/teachers/' + ensId)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#e04f00', fontSize: '0.7rem', fontWeight: 700, padding: 0, display: 'flex', alignItems: 'center', gap: '4px', textDecoration: 'underline' }}>
