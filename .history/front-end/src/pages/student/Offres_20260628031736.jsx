    ...
    async function fetchDemandes() {
      try {
        ...
        const data = (res.data || []).filter(d => {
          const matiere = d.matiere?.toLowerCase() || '';
          return matiere !== 'test' && matiere !== 'testtest' && matiere !== 'test test' && matiere.trim() !== '';
        });
        setDemandes(data);
          ...
          <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            {loading ? (
              ...
              <div style={{ padding: '3rem', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', background: bgCard, border: '1px solid ' + border, borderRadius: '20px' }}>
                ...
                <p style={{ fontSize: '0.82rem', color: muted, margin: 0, fontWeight: 600 }}>Aucune demande valide — les offres apparaitront ici</p>
              </div>
            ) : (
              <>
