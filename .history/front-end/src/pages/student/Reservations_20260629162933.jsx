...
export default function StudentReservations() {
  ...
  // Numéro WhatsApp depuis les données enseignant
                    ...
                    <div key={r.id_reservation}
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap', flexShrink: 0 }}>
                          ...
                          {/* PAIEMENT_RECU : en attente de confirmation prof — aucun bouton contacter */}
                      ...
                      {/* Message d'attente quand paiement_recu */}
                      {r.statut === 'paiement_recu' && (
                        <div style={{ marginTop: '12px', padding: '10px 14px', background: 'rgba(168,85,247,0.06)', border: '1px solid rgba(168,85,247,0.2)', borderRadius: '10px', display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                          <Clock size={14} color="#a855f7" style={{ flexShrink: 0, marginTop: '1px' }} />
                          <div>
                            <div style={{ fontSize: '0.72rem', fontWeight: 800, color: '#a855f7', marginBottom: '2px' }}>
