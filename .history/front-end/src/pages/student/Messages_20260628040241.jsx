...
export default function StudentMessages() {
  ...
  // reservationId passé depuis Offres ou Reservations
    ...
    async function fetchConversations() {
      try {
        ...
        if (confirmed.length > 0) {
          // CORRECTION : chercher APRES que confirmed est rempli
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ fontSize: '0.65rem', color: '#e04f00', fontWeight: 700, fontFamily: 'monospace', textTransform: 'uppercase', marginBottom: '2px' }}>
                            {r.creneau?.jour} {r.creneau?.heureDebut?.slice(0, 5)} — {r.creneau?.heureFin?.slice(0, 5)}
                          </div>
