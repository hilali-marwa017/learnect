...
export default function StudentReservations() {
  ...
  // ✅ FIX 1 : vérifier la date ET l'heure, pas seulement l'heure
  function peutTerminer(reservation) {
    ...
    // Construire la date complète de fin du cours
  ...
  // ✅ FIX 2 : jours déjà en français dans le backend → pas de traduction nécessaire
  function getJourFrancais(jour) {
    if (!jour) return '';
    // Le backend stocke directement : lundi, mardi, mercredi...
    // On met juste la première lettre en majuscule
