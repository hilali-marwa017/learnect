...
export default function StudentReservations() {
  ...
  // useEffect + async/await — DAIF chap 5 & 6
  useEffect(() => {
  ...
  // supprimer une reservation — DAIF chap 7 (listes dynamiques)
  ...
  // terminer un cours — FIX PRINCIPAL
  async function handleTerminer(id) {
    ...
    try {
      ...
      // mettre a jour le state sans recharger — DAIF chap 7 (toggle)
          ...
          <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            {loading ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                {/* map() sur les reservations — DAIF chap 3 & 7 */}
                {reservations.map(r => {
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap', flexShrink: 0 }}>
                          ...
                          {/* ✅ FIX PRINCIPAL : bouton terminer le cours */}
                          {r.statut === 'confirmee' && (
                            <button
                      ...
                      {/* formulaire avis — visible seulement si statut === terminee */}
