...
export default function StudentMessages() {
  ...
  const activeConvBorderColor = '#e04f00';
              ...
              <div style={{ flex: 1, overflowY: 'auto' }}>
                {loading ? (
                  ...
                  filteredReservations.map(r => {
                    ...
                    return (
                      <button key={r.id_reservation} onClick={() => setActiveRes(r)} style={{ width: '100%', textAlign: 'left', padding: '1rem', display: 'flex', gap: '12px', alignItems: 'flex-start', background: isActive ? activeConvBg : 'transparent', borderLeft: isActive ? '3px solid ' + activeConvBorderColor : '3px solid transparent', borderRight: 'none', borderTop: 'none', borderBottom: '1px solid ' + borderSub, cursor: 'pointer', transition: 'all 0.15s' }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div style={{ fontSize: '0.82rem', fontWeight: 700, color: text, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', marginBottom: '2px' }}>{p?.prenom} {p?.nom}</div>
            ...
            {activeRes ? (
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ padding: '1rem 1.25rem', borderBottom: '1px solid ' + border, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px', background: bgCard }}>
                  ...
                  {profId && (
                    <button onClick={() => navigate('/teachers/' + profId)} style={{ display: 'flex', alignItems: 'center', gap: '5px', padding: '5px 10px', borderRadius: '8px', border: '1px solid ' + border, background: 'transparent', color: muted, fontSize: '0.68rem', fontWeight: 600, cursor: 'pointer', flexShrink: 0 }}>
