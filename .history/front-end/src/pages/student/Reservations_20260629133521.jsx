...
// Composant : Liste des réservations étudiant + Gestion paiement
// ============================================================
              ...
              return (
                <div style={{ 
                  ...
                  <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center' }}>
                    {/* ✅ WhatsApp UNIQUEMENT après confirmation (statut = confirmee) */}
                    {whatsappNum && !isPaiementRecu && (
                    ...
                    {/* ✅ Contacter UNIQUEMENT après confirmation (statut = confirmee) */}
                    {!isPaiementRecu && (
                      <button
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap', flexShrink: 0 }}>
                          ...
                          {r.statut === 'confirmee' && canTerminer && (
                            <button
                              onClick={() => handleTerminer(r.id_reservation)}
                              disabled={isTermining}
