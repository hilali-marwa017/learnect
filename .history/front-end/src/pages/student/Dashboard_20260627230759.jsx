...
export function StudentNavigationActive({ activeTab, isDark }) {
  ...
  // ✅ CORRIGE : vrai compteur de messages non lus (et non du nombre de reservations confirmees)
  useEffect(() => {
  ...
  // ✅ NOUVEAU : compteur d'offres en attente recues, pour le badge "Offres et Packs"
  useEffect(() => {
