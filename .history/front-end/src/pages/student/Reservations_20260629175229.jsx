...
export default function StudentReservations() {
  ...
  // ✅ CORRIGÉ : handleContacter avec plus d'infos
                    ...
                    <div key={r.id_reservation}
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap', flexShrink: 0 }}>
                          ...
                          {/* ===== PAIEMENT_RECU : RIEN sauf badge — message en dessous ===== */}
                          {/* (pas de bouton contacter, pas de whatsapp) */}
                      ...
                      {/* ===== MESSAGE ATTENTE QUAND PAIEMENT_RECU ===== */}
                      {r.statut === 'paiement_recu' && (
                        <div style={{ marginTop: '14px', padding: '14px 16px', background: isDark ? 'rgba(168,85,247,0.08)' : 'rgba(168,85,247,0.05)', border: '1px solid rgba(168,85,247,0.25)', borderRadius: '12px', display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                          <div style={{ width: '32px', height: '32px', borderRadius: '50%', background: 'rgba(168,85,247,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                            <Clock size={15} color="#a855f7" />
                          </div>
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                            <div style={{ fontSize: '0.78rem', fontWeight: 800, color: '#a855f7' }}>
                              ⏳ Paiement reçu — En attente de confirmation du professeur
                            </div>
                            <div style={{ fontSize: '0.72rem', color: muted, lineHeight: 1.6 }}>
                              Votre paiement a bien été enregistré. Le professeur doit maintenant accepter votre réservation. Le numéro WhatsApp et la messagerie seront disponibles dès sa confirmation.
                            </div>
                          </div>
                        </div>
                      )}
