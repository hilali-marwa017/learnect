...
import { Award, Check, X, Clock, CheckCircle } from 'lucide-react';
                ...
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                  {demandes.map(d => (
                    <button
                      ...
                      style={{ padding: '8px 16px', borderRadius: '10px', border: `1px solid ${activeTab === d.id_demande ? '#e04f00' : border}`, background: activeTab === d.id_demande ? '#e04f00' : 'transparent', color: activeTab === d.id_demande ? '#ffffff' : muted, fontSize: '0.75rem', fontWeight: 700, cursor: 'pointer', fontFamily: 'monospace' }}
                    >
                      {d.matiere}
                    </button>
                  ))}
                            ...
                            <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                              <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: '#e04f00', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                                <span style={{ color: '#fff', fontSize: '0.8rem', fontWeight: 700 }}>
                                  {o.enseignant?.user?.prenom?.charAt(0)}{o.enseignant?.user?.nom?.charAt(0)}
                                </span>
                              </div>
                              <div>
                                ...
                                <div style={{ fontSize: '0.7rem', color: '#e04f00', fontWeight: 700 }}>
                                  {o.enseignant?.titre || 'Professeur'}
                                </div>
                              </div>
                            </div>
