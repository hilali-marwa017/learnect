...
export default function StudentReservations() {
  ...
  // ✅ HANDLE PAIEMENT CONFIRME - AVEC FERMETURE DU MODAL
  async function handlePaiementConfirme() {
    ...
    try {
      ...
      setPaymentTarget(null); // ✅ FERME LE MODAL
    }
  }
  ...
  return (
    <div style={{ minHeight: '100vh', background: bg, paddingTop: '2rem', paddingBottom: '4rem' }}>
                ...
                {reservations.map(r => {
                  ...
                  return (
                    <div key={r.id_reservation}
                      ...
                      {/* ===== MESSAGE PAIEMENT_RECU (SANS BOUTON) ===== */}
                      {r.statut === 'paiement_recu' && (
                        <div style={{ 
                          ...
                          {/* ✅ SUPPRIMÉ : 📋 MES RÉSERVATIONS et 🔒 MESSAGERIE */}
                        </div>
                      )}
      ...
      {/* ✅ PAYMENT MODAL AVEC CALLBACK CORRECT */}
