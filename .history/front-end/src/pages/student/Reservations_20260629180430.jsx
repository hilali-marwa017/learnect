  ...
  useEffect(() => {
    async function fetchReservations() {
      try {
        ...
        // ✅ TRI : les nouvelles réservations en premier (par date de création)
                ...
                {reservations.map(r => {
                  ...
                  return (
                    <div key={r.id_reservation}
                      ...
                      {/* ===== MESSAGE ATTENTE POUR PAIEMENT_RECU ===== */}
                      {r.statut === 'paiement_recu' && (
                        <div style={{ 
                          ...
                          <div style={{ 
                            ...
                            <span style={{ color: '#a855f7' }}>📋 MES RÉSERVATIONS</span>
                            <span style={{ color: muted, opacity: 0.5 }}>☐ MESSAGERIE</span>
                          </div>
                        </div>
                      )}
