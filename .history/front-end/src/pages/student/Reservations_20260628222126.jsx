        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', flex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <span style={{ fontSize: '0.72rem', color: '#16a34a', fontWeight: 700 }}>
              Vous avez déjà laissé un avis pour ce cours.
            </span>
          </div>
          {avisExistant && (
            <>
...
export default function StudentReservations() {
  ...
  // ✅ Vérifier si le cours peut être terminé (heure de fin passée)
  const peutTerminer = (reservation) => {
    ...
    return maintenant >= heureFinDate;
  };

  // ✅ Obtenir le message d'attente
  ...
  // ✅ Fonction pour obtenir le jour en français
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '0.75rem', color: muted, margin: 0 }}>
                      {confirmedInfo.methode === 'cash'
                        ...
                        : 'Paiement par carte de ' + confirmedInfo.montant + ' confirmé.'}
                    </p>
                  </div>
