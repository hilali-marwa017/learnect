    ...
    return (
        <div style={{ minHeight: '100vh', background: bg, paddingTop: '2rem', paddingBottom: '4rem' }}>
            <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div style={{ borderBottom: `1px solid ${border}`, paddingBottom: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '1rem' }}>
                    <div>
                        ...
                        <p style={{ fontSize: '0.8rem', color: muted, margin: 0 }}>
                            Toutes vos alertes en temps reel — reservations, offres, messages et paiements.
                        </p>
                    </div>
                    {unread > 0 && (
                        <button
                ...
                {/* Footer info */}
                {notifications.length > 0 && (
                    <p style={{ textAlign: 'center', fontSize: '0.7rem', color: muted, fontFamily: 'monospace', margin: 0 }}>
                        {notifications.length} notification{notifications.length > 1 ? 's' : ''} au total — actualisation automatique toutes les 30 secondes
                    </p>
                )}
