...
import { CheckCircle, XCircle, Trash2, Loader, FileText, Image, Phone } from 'lucide-react';
import api from '../../api/axios';

// composant pour afficher un lien de document
...
// composant pour gerer les utilisateurs
                        ...
                        {users.length === 0 ? (
                            ...
                            <tr key={u.utilisateur_id ?? i} style={{ borderBottom: '1px solid var(--color-border)' }}>
                                <td style={{ padding: '12px', fontSize: '0.78rem', color: 'var(--color-text)' }}>
                                    ...
                                    {/* ✅ Ajout du téléphone avec icône Phone */}
                                    {u.telephone && (
...
// composant pour gerer les verifications des enseignants
