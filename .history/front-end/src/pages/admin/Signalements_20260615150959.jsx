                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  {s.statut !== 'traite' && (
                    <button onClick={() => traiterSignalement(s.id)} disabled={loadingId === s.id}
                      style={{ padding: '6px 14px', borderRadius: '8px', border: 'none', background: orange, color: '#fff', fontSize: '0.72rem', fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px', opacity: loadingId === s.id ? 0.6 : 1 }}>
