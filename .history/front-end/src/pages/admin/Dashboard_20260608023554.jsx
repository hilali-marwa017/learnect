  ...
  return (
    <div className="container-fluid p-4" style={{ background: '#f5f7fa', minHeight: '100vh' }}>
      ...
      <div className="mb-4 border-bottom">
        <div className="d-flex">
          {['stats','teachers','reports','demandes','reservations','paiements','users'].map((tab, idx) => {
            ...
            return (
              <button key={tab} onClick={() => setOnglet(tab)} style={{ flex: 1, border: 'none', background: 'none', padding: '12px 4px', fontSize: '13px', fontWeight: onglet === tab ? 'bold' : 'normal', color: onglet === tab ? '#0d6efd' : '#6c757d', borderBottom: onglet === tab ? '2px solid #0d6efd' : 'none', cursor: 'pointer' }}>
        ...
        <div className="row g-3">
          <div className="col-md-6">
            <div className="card p-4 border-0 shadow-sm">
              ...
              <div style={{ height: '280px' }}><canvas ref={graphRef}></canvas></div>
            </div>
          </div>
          <div className="col-md-6">
      ...
      {onglet === 'demandes' && (
        <div className="card border-0 shadow-sm">
          <div className="card-header bg-white">
            <h5 className="mb-0">LISTE DES DEMANDES ({demandes.length})</h5>
          </div>
      ...
      {onglet === 'reservations' && (
        <div className="card border-0 shadow-sm">
          <div className="card-header bg-white">
            <h5 className="mb-0">LISTE DES RÉSERVATIONS ({reservations.length})</h5>
          </div>
          <div className="card-body p-0">
            <div className="table-responsive">
              <table className="table table-bordered mb-0">
      ...
      {onglet === 'paiements' && (
        <div className="card border-0 shadow-sm">
          <div className="card-header bg-white">
            <h5 className="mb-0">HISTORIQUE DES PAIEMENTS ({paiements.length})</h5>
          </div>
          <div className="card-body p-0">
            <div className="table-responsive">
              <table className="table table-bordered mb-0">
