    ...
    <div className="card border-0 shadow-sm rounded-4">
      <div className="card-body p-4">
        ...
        {pendingTeachers.length === 0 ? (
          <div className="text-center py-5"><div className="bg-success bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3" style={{ width: '64px', height: '64px' }}><i className="bi bi-check-lg fs-2 text-success"></i></div><p className="text-muted mb-0">Aucun enseignant en attente</p></div>
        ) : (
