...
function AdminDashboard() {
  ...
  return (
    <div className="container-fluid p-4" style={{ background: '#f5f7fa', minHeight: '100vh' }}>
      ...
      {/* Demandes Table - same design as Utilisateurs */}
      {onglet === 'demandes' && (
            ...
            <div className="table-responsive">
              <table className="table mb-0" style={{ minWidth: '800px' }}>
                ...
                <tbody>
                  {demandes.length === 0 ? (
                    <tr>
                      <td colSpan="6" className="text-center py-5 text-muted">Aucune demande trouvée</td>
                    </tr>
                  ) : (
      ...
      {/* Réservations Table - same design as Utilisateurs */}
      {onglet === 'reservations' && (
        <div className="card border-0 shadow-sm" style={{ transition: 'none', transform: 'none' }}>
          <div className="card-header bg-white p-3 border-bottom">
              ...
              <table className="table mb-0" style={{ minWidth: '900px' }}>
                ...
                <tbody>
                  {reservations.length === 0 ? (
                    <tr>
                      <td colSpan="7" className="text-center py-5 text-muted">Aucune réservation trouvée</td>
                    </tr>
                  ) : (
      ...
      {/* Paiements Table - same design as Utilisateurs */}
      {onglet === 'paiements' && (
        <div className="card border-0 shadow-sm" style={{ transition: 'none', transform: 'none' }}>
          <div className="card-header bg-white p-3 border-bottom">
            ...
            <div className="table-responsive">
              <table className="table mb-0" style={{ minWidth: '800px' }}>
                ...
                <tbody>
                  {paiements.length === 0 ? (
                    <tr>
                      <td colSpan="7" className="text-center py-5 text-muted">Aucun paiement trouvé</td>
                    </tr>
                  ) : (
                    paiements.map((p, index) => (
                      <tr key={p.id} style={{ borderBottom: '1px solid #eee' }}>
                        ...
                        <td className="px-3 py-3">
                          <span className="badge bg-secondary">{p.mode_paiement || 'carte'}</span>
                        </td>
                        <td className="px-3 py-3">
