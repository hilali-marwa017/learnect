      ...
      <div className="card-body p-4">
        <div className="d-flex align-items-center gap-3 mb-4 pb-2 border-bottom">
          ...
          <div>
            ...
            <p className="text-muted small mb-0">{pending.length} signalements en attente</p>
          </div>
        </div>
        ...
        {pending.length === 0 ? (
          <div className="text-center py-5">
            ...
            <p className="text-muted mb-0">Aucun signalement en attente</p>
          </div>
        ) : (
                ...
                <div className="border rounded-3 p-3 bg-white">
                  ...
                  <div className="bg-light rounded-3 p-3 mb-3">
                    <div className="small text-muted mb-2">
                      <i className="bi bi-chat-quote me-1"></i> Avis signalé :
                    </div>
                  ...
                  <div className="bg-warning bg-opacity-10 rounded-3 p-3 mb-3">
                    <div className="small text-muted mb-2">
                      <i className="bi bi-info-circle me-1"></i> Motif du signalement :
                    </div>
                    <p className="mb-0 small fw-medium">{s.motif}</p>
                  </div>

                  <div className="d-flex gap-2 justify-content-end">
                    <button onClick={() => handleTraiter(s.id_signalement)} className="btn btn-primary btn-sm px-4">
                      <i className="bi bi-check-lg me-1"></i> Rejeter le signalement
                    </button>
                    <button onClick={() => handleSupprimerAvis(s.id_avis, s.id_signalement)} className="btn btn-danger btn-sm px-4">
