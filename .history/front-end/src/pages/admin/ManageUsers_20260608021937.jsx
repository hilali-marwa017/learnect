...
function ManageUsers({ users = [], onRefresh }) {
  ...
  // confirmAction = { id, action: 'bloquer' | 'debloquer' | 'supprimer', nom }
                    ...
                    <div className="d-flex gap-2">
                      {enChargement ? (
                        ...
                        <>
                          {estActif ? (
                            <button
                              onClick={() => setConfirmAction({ id: u.utilisateur_id, action: 'bloquer', nom: `${u.prenom} ${u.nom}` })}
                            ...
                            <button
                              onClick={() => setConfirmAction({ id: u.utilisateur_id, action: 'debloquer', nom: `${u.prenom} ${u.nom}` })}
                              className="btn btn-sm px-3 py-1 rounded-pill"
                          ...
                          <button
                            onClick={() => setConfirmAction({ id: u.utilisateur_id, action: 'supprimer', nom: `${u.prenom} ${u.nom}` })}
                            className="btn btn-sm px-3 py-1 rounded-pill"
