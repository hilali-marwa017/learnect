        ...
        <div className="bg-white rounded-4 border p-4" style={{ transition: 'none', transform: 'none' }}>
          ...
          <div className="overflow-x-auto">
            <table style={tableStyle}>
              <thead>
                <tr><th style={thStyle}>ÉTUDIANT</th><th style={thStyle}>TYPE</th><th style={thStyle}>MESSAGE</th><th style={thStyle}>STATUT</th><th style={thStyle}>DATE</th></tr>
              </thead>
              <tbody>
                {demandes.length === 0 ? (
                  <td><td colSpan="5" style={{ padding: '40px', textAlign: 'center', color: '#94a3b8' }}>Aucune demande trouvée</td></tr>
                ) : (
                  demandes.map((d) => (
        ...
        <div className="bg-white rounded-4 border p-4" style={{ transition: 'none', transform: 'none' }}>
          ...
          <div className="overflow-x-auto">
            <table style={{ ...tableStyle, minWidth: '800px' }}>
              <thead>
                <tr><th style={thStyle}>ÉTUDIANT</th><th style={thStyle}>ENSEIGNANT</th><th style={thStyle}>DATE</th><th style={thStyle}>MONTANT</th><th style={thStyle}>COMMISSION</th><th style={thStyle}>STATUT</th></tr>
              </thead>
              <tbody>
        ...
        <div className="bg-white rounded-4 border p-4" style={{ transition: 'none', transform: 'none' }}>
          ...
          <div className="overflow-x-auto">
            <table style={{ ...tableStyle, minWidth: '700px' }}>
              <thead>
                <tr><th style={thStyle}>ÉTUDIANT</th><th style={thStyle}>MONTANT</th><th style={thStyle}>COMMISSION</th><th style={thStyle}>MODE</th><th style={thStyle}>STATUT</th><th style={thStyle}>DATE</th></tr>
              </thead>
              <tbody>
                {paiements.length === 0 ? (
