        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {reservations.length === 0 ? (
              ...
              <tr key={r.id_reservation ?? i} style={tableRow}>
                <td style={tableCell}>
    ...
    <div style={{ background: card, border: `1px solid ${border}`, borderRadius: '16px', padding: '1.5rem', boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
        {demandes.length === 0 ? (
          ...
          <div key={d.id ?? i} style={{ background: bg, border: `1px solid ${border}`, borderRadius: '10px', padding: '1rem' }}>
