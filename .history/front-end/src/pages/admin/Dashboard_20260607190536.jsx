  ...
  return (
    <div className="container py-4">
      <div className="bg-dark text-white rounded-4 p-4 mb-4">
        <h1 className="h3 mb-2">Administration Learnect</h1>
        <p className="text-white-50">Gestion complète de la plateforme</p>
      </div>
      ...
      <ul className="nav nav-tabs mb-4">
        ...
        <li className="nav-item"><button className={`nav-link ${activeTab === 'teachers' ? 'active' : ''}`} onClick={() => setActiveTab('teachers')}>Validation</button></li>
