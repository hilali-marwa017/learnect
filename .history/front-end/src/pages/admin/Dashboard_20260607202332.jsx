        ...
        {activeTab === 'stats' && (
          <div>
            <div className="row g-3 mb-4">
              ...
              <div className="col-md-3"><div className="card p-3 text-center"><div className="text-muted small">Commissions</div><div className="fs-2 fw-bold text-primary">{stats.revenusTotal} DH</div></div></div>
            </div>
            ...
            <div className="card p-4 mb-4">
              <div className="d-flex justify-content-between align-items-center pb-3 border-bottom">
                ...
                <div className="bg-light px-3 py-1 rounded-pill small fw-bold"><i className="bi bi-graph-up me-1"></i> Croissance +22%</div>
              </div>
              <div className="row mt-3">
                    ...
                    {months.map((m, i) => {
                      ...
                      return (
                        <div key={i} className="flex-grow-1 text-center">
                          <div className="bg-light rounded-top overflow-hidden" style={{ height: '150px' }}>
                            <div className="bg-primary" style={{ height: `${height}%` }}></div>
                          </div>
                          <div className="small fw-bold mt-2">{m}</div>
                          <div className="small text-muted">{volumes[i]} DH</div>
                        </div>
                      );
                    })}
                  </div>
                ...
                <div className="col-md-4">
                  <div className="bg-light p-3 rounded-3">
                    ...
                    <div className="mt-2 small"><span className="text-muted">Volume de pointe :</span> <strong>Juin (28 700 DH)</strong></div>
                    <div className="mt-1 small"><span className="text-muted">Total Commissions :</span> <strong className="text-primary">10 863 DH</strong></div>
                    <div className="mt-1 small"><span className="text-muted">Tuteurs actifs :</span> <strong>Sofia, Amine, Laila</strong></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card p-4">
              ...
              <div className="bg-light p-3 rounded-3 mt-3 small">
                <p className="mb-1">✓ 10% de commission, 90% pour l'enseignant.</p>
                <p className="mb-0">✓ Modération instantanée visible globalement.</p>
              </div>
            </div>
          </div>
        )}
