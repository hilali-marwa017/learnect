...
function DocLink({ doc }) {
  ...
  const bgColor = hovered ? 'rgba(224,79,0,0.06)' : 'var(--color-bg)';
  return (
      ...
      style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '6px 14px', borderRadius: '8px', border: '1px solid var(--color-border)', background: bgColor, textDecoration: 'none', color: '#e04f00', fontSize: '0.72rem', fontWeight: 600, transition: 'background 0.15s' }}
    >
