...
export default function AdminDashboard() {
  ...
  const renderContent = () => {
    // correction : on passe maintenant setUsers a VerificationsTab pour que
    // l'approbation/refus mette aussi a jour la liste "Comptes Utilisateurs"
    // sans avoir besoin de recharger la page
    if (activeTab === 'teachers') return <VerificationsTab enseignantsAttente={enseignantsAttente} setEnseignantsAttente={setEnseignantsAttente} setUsers={setUsers} />;
