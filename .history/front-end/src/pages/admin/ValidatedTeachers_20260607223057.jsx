...
function ValidatedTeachers({ pendingTeachers, onRefresh }) {
  ...
  return (
    <div className="card border-0 shadow-sm rounded-4">
              ...
              <div className="border rounded-3 p-3 bg-white">
                ...
                <div className="mt-3 d-flex gap-2 justify-content-end">
                  <button 
                    ...
                    style={{ background: '#198754', color: 'white', border: 'none', borderRadius: '6px', padding: '6px 16px', fontSize: '12px', fontWeight: 'bold' }}
                  >
                  ...
                  <button 
                    ...
                    style={{ border: '1px solid #dc3545', background: 'white', color: '#dc3545', borderRadius: '6px', padding: '6px 16px', fontSize: '12px', fontWeight: 'bold' }}
                  >
      ...
      {/* MODAL DE REFUS - STYLE COMME DANS L'IMAGE */}
      {refuseId && (
          ...
          <div className="bg-white rounded-3 p-4" style={{ width: '450px' }}>
            ...
            <div className="d-flex gap-2 justify-content-end">
              <button 
                ...
                disabled={isLoading}
                style={{ background: '#f8f9fa', border: '1px solid #e2e8f0', borderRadius: '6px', padding: '8px 20px' }}
              >
                Annuler
              </button>
              <button 
                ...
                disabled={isLoading}
                style={{ background: '#dc3545', color: 'white', border: 'none', borderRadius: '6px', padding: '8px 20px' }}
              >
