        ...
        <div className="row g-3">
          {pendingTeachers.map(t => (
            <div key={t.utilisateur_id} className="col-12">
              <div className="border rounded-3 p-3 bg-white" style={{ transition: 'none', transform: 'none' }}>
                <div className="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-3">
                  ...
                  <div className="bg-light rounded-3 p-2 text-center" style={{ minWidth: '100px', transition: 'none', transform: 'none' }}>
                    <div className="small text-muted">Tarif horaire</div>
                    <div className="fw-bold text-primary">{t.tarifHeure} DH/h</div>
                  </div>
                </div>

                <div className="bg-white p-3 rounded-2 border mb-3" style={{ transition: 'none', transform: 'none' }}>
                  <p className="fw-bold mb-2 small"><i className="bi bi-file-text me-1"></i> DIPLÔME ACADÉMIQUE :</p>
                  <div className="bg-light p-2 rounded-2 mb-2" style={{ transition: 'none', transform: 'none' }}>
                  ...
                  <div className="row g-2">
                    <div className="col-md-6">
                      ...
                      <div className="bg-light p-2 rounded-2" style={{ transition: 'none', transform: 'none' }}>{t.cin_recto || 'non fourni'}</div>
                    </div>
                    <div className="col-md-6">
                      <p className="fw-bold mb-1 small"><i className="bi bi-card-image me-1"></i> CIN (VERSO) :</p>
                      <div className="bg-light p-2 rounded-2" style={{ transition: 'none', transform: 'none' }}>{t.cin_verso || 'non fourni'}</div>
                    </div>
                  </div>
                </div>

                <div className="mt-2 p-2 bg-light rounded-2" style={{ transition: 'none', transform: 'none' }}>
                ...
                <div className="mt-3 d-flex gap-2 justify-content-end">
                  <button 
                    ...
                    style={{ background: '#198754', color: 'white', border: 'none', borderRadius: '6px', padding: '6px 16px', fontSize: '12px', fontWeight: 'bold', transition: 'none' }}
                  >
                  ...
                  <button 
                    ...
                    style={{ border: '1px solid #dc3545', background: 'white', color: '#dc3545', borderRadius: '6px', padding: '6px 16px', fontSize: '12px', fontWeight: 'bold', transition: 'none' }}
                  >
          ...
          <div className="bg-white rounded-3 p-4" style={{ width: '450px', transition: 'none', transform: 'none' }}>
            ...
            <div className="d-flex gap-2 justify-content-end">
              <button 
                ...
                disabled={isLoading}
                style={{ background: '#f8f9fa', border: '1px solid #e2e8f0', borderRadius: '6px', padding: '8px 20px', transition: 'none' }}
              >
                Annuler
              </button>
              <button 
                ...
                disabled={isLoading}
                style={{ background: '#dc3545', color: 'white', border: 'none', borderRadius: '6px', padding: '8px 20px', transition: 'none' }}
              >
