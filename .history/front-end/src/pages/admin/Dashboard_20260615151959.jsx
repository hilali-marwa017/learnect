    ...
    if (barRef.current) {
      barInstance.current = new Chart(barRef.current, {
        ...
        options: {
          ...
          scales: {
            x: { grid: { color: 'rgba(128,128,128,0.1)' }, ticks: { color: 'var(--color-muted)', font: { size: 11 } }, border: { display: false } },
            y: { grid: { display: false }, ticks: { color: 'var(--color-text)', font: { size: 12 } }, border: { display: false } }
          }
        }
      });
    }
  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: 'var(--color-bg)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '1.5rem', display: 'flex', gap: '1.5rem' }}>
          {/* SIDEBAR */}
          <aside style={{ width: '240px', flexShrink: 0, position: 'sticky', top: '20px', alignSelf: 'flex-start' }}>
                  ...
                  return (
                    <button 
                      ...
                      style={{ 
                        ...
                        fontSize: '0.8rem', fontWeight: isActive ? 700 : 500, marginBottom: '2px', textAlign: 'left', transition: 'all 0.15s' 
                      }}
                    >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5,1fr)', gap: '1rem' }}>
                  {[
                    ...
                    <div key={i} style={{ background: 'var(--color-card)', border: '1px solid var(--color-border)', borderRadius: '14px', padding: '1.1rem 1rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                  <div style={{ background: 'var(--color-card)', border: '1px solid var(--color-border)', borderRadius: '16px', padding: '1.5rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
                      <span style={{ fontSize: '0.7rem', color: 'var(--color-muted)', display: 'flex', alignItems: 'center', gap: '6px' }}><span style={{ width: '10px', height: '10px', background: orange, borderRadius: '3px', display: 'inline-block' }} /> Élèves ({stats.totalEtudiants})</span>
