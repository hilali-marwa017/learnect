            ...
            <div className="card border-0 shadow-sm p-4 mb-4">
              ...
              <div className="row mt-3">
                <div className="col-md-8">
                  <div className="d-flex align-items-end justify-content-between gap-2" style={{ height: '280px' }}>
                    {months.map((m, i) => {
                      const height = (volumes[i] / maxVolume) * 100;
                      return (
                        <div key={i} className="flex-grow-1 text-center">
                          <div className="bg-light rounded-top overflow-hidden" style={{ height: '200px', background: '#e2e8f0' }}>
                            <div className="bg-primary" style={{ height: `${height}%`, width: '100%', background: 'linear-gradient(to top, #0d6efd, #60a5fa)' }}></div>
                          </div>
