        ...
        {pending.map(s => (
          <div key={s.id_signalement} className="border rounded-3 p-3 mb-3">
            ...
            <div className="d-flex gap-2 justify-content-end">
              <button onClick={() => handleTraiter(s.id_signalement)} disabled={isLoading} className="btn btn-outline-primary btn-sm px-4">
                <i className="bi bi-check-lg me-1"></i> Rejeter
              </button>
              <button onClick={() => handleSupprimerAvis(s.id_avis, s.id_signalement)} disabled={isLoading} className="btn btn-danger btn-sm px-4">
