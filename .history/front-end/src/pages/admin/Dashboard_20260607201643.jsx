                      ...
                      return (
                        <div key={i} className="flex-1 flex flex-col items-center">
                          <div className="w-full bg-slate-100 rounded-t-xl overflow-hidden h-32 flex items-end">
                            <div className="w-full bg-gradient-to-t from-blue-600 to-blue-500 rounded-t-xl" style={{ height: `${height}%` }}></div>
                          </div>
                          <span className="text-[10px] font-black mt-2 uppercase">{m}</span>
                          <span className="text-[9px] text-slate-400">{volumes[i]} DH</span>
                        </div>
                      );
                    })}
                  </div>
