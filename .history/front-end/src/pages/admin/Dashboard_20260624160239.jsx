  ...
  return (
    <div style={{ minHeight: '100vh', background: bg, paddingTop: '20px' }}>
      <div className="admin-layout" style={{ 
        ...
        display: 'flex', 
        gap: '1.5rem',
        alignItems: 'flex-start' // IMPORTANT: aligne les éléments en haut
      }}>
        ...
        <aside className="admin-sidebar" style={{ 
          ...
          position: 'sticky', 
          top: '90px',
          height: 'fit-content', // La sidebar prend seulement la hauteur nécessaire
          maxHeight: 'calc(100vh - 100px)', // Limite la hauteur pour éviter qu'elle dépasse l'écran
          overflowY: 'auto', // Permet de scroller la sidebar si elle est trop longue
          alignSelf: 'flex-start' // Aligne la sidebar en haut
        }}>
          <div style={{ 
            background: card, 
