...
function AdminDashboard() {
  ...
  async function chargerDonnees() {
    ...
    try {
      ...
      console.log('Signalements status:', signalementsRes.status);
      ...
      <div className="container-xl">
        <div className="bg-dark text-white rounded-4 p-4 mb-4">
          <div className="d-flex align-items-center gap-3">
            <div className="bg-white bg-opacity-10 p-3 rounded-3"><i className="bi bi-shield-check fs-4"></i></div>
            <div>
              <span className="badge bg-white bg-opacity-20 mb-1" style={{ fontSize: '10px' }}>CONSOLE ADMIN</span>
