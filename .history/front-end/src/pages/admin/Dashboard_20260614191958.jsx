        ...
        <div className="border-b border-hairline-strong pb-6 space-y-1 flex justify-between items-end flex-wrap gap-4">
          <div>
            ...
            <p className="text-charcoal text-xs">
              Pilotez la qualité pédagogique, vérifiez les dossiers d'accréditation et gérez les plaintes de Learnect.ma.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-grow space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-6">
              ...
              <div className="bg-surface-card border border-hairline-strong p-5 rounded-xl space-y-1">
                <span className="text-[9px] font-mono font-bold text-mute uppercase block">EN ATTENTE</span>
                <p className="text-2xl font-black text-accent-orange">{enseignantsEnAttente.length} candidats</p>
              </div>
              <div className="bg-surface-card border border-hairline-strong p-5 rounded-xl space-y-1">
              ...
              <div className="bg-surface-card border border-hairline-strong p-5 rounded-xl space-y-1">
                <span className="text-[9px] font-mono font-bold text-mute uppercase block">FACTURES TRAITÉES</span>
            ...
            <div className="bg-surface-card border border-hairline-strong rounded-2xl p-6 md:p-8 space-y-6">
              <h3 className="text-sm font-bold uppercase tracking-wider text-ink font-mono border-b border-hairline pb-3">
                Candidatures Enseignants en attente de validation manuelle
              </h3>
              ...
              {enseignantsEnAttente.length > 0 ? (
                <div className="space-y-4">
                  {enseignantsEnAttente.map(function (candidat) {
                    return (
                      <div
                        key={candidat.id}
                        className="p-5 bg-surface-deep/30 border border-hairline rounded-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6 hover:border-accent-orange/15 transition-all"
                      >
                        <div className="space-y-1">
                          ...
                          {candidat.bio && (
                            <p className="text-xs text-charcoal leading-relaxed mt-1">"{candidat.bio}"</p>
                          )}
                        </div>

                        <div className="shrink-0 flex items-center gap-2 self-stretch md:self-auto justify-end border-t md:border-t-0 border-hairline pt-3 md:pt-0">
                          <button
                ...
                <div className="text-center py-10 bg-surface-deep/25 rounded-xl space-y-1 text-xs">
                  ...
                  <p className="text-mute font-bold font-mono">File d'attente d'enregistrement propre.</p>
                  <p className="text-mute">Toutes les inscriptions ont été inspectées par vos soins.</p>
                </div>
              )}
            </div>
