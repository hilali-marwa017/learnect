    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          >
            <i className={`bi ${role === 'etudiant' ? 'bi-person-graduation' : 'bi-person'}`} style={{ fontSize: '1.1rem' }}></i>
          ...
          >
            <i className={`bi ${role === 'enseignant' ? 'bi-person-workspace' : 'bi-person-badge'}`} style={{ fontSize: '1.1rem' }}></i>
            ...
            <div style={{
              ...
              <div style={{ marginBottom: '12px' }}>
                <label style={{ fontSize: '0.7rem', fontWeight: '500', color: '#475569', display: 'block', marginBottom: '4px' }}>
                  <i className="bi bi-book" style={{ marginRight: '4px' }}></i> Matière d'enseignement
                </label>
                <select
                  name="matiere"
                  value={form.matiere}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
                <div>
                  <label style={{ fontSize: '0.7rem', fontWeight: '500', color: '#475569', display: 'block', marginBottom: '4px' }}>
                    <i className="bi bi-cash-stack" style={{ marginRight: '4px' }}></i> Tarif horaire (DH)
                  </label>
                  <input
                    type="number"
                    name="tarifHeure"
                ...
                <div>
                  <label style={{ fontSize: '0.7rem', fontWeight: '500', color: '#475569', display: 'block', marginBottom: '4px' }}>
                    <i className="bi bi-calendar-check" style={{ marginRight: '4px' }}></i> Années d'expérience
                  </label>
                  <select
                    name="experience"
              ...
              <div style={{ marginBottom: '12px' }}>
                <label style={{ fontSize: '0.7rem', fontWeight: '500', color: '#475569', display: 'block', marginBottom: '4px' }}>
                  <i className="bi bi-award" style={{ marginRight: '4px' }}></i> Intitulé du diplôme
                </label>
                <input
                  type="text"
                  name="diplomeTitle"
              ...
              <div style={{ marginBottom: '12px' }}>
                <label style={{ fontSize: '0.7rem', fontWeight: '500', color: '#475569', display: 'block', marginBottom: '4px' }}>
                  <i className="bi bi-card-image"></i> Carte d'identité (Recto)
                </label>
                <div style={{
                ...
                onMouseOut={e => e.currentTarget.style.borderColor = '#cbd5e1'}>
                  ...
                  <label htmlFor="cin_recto" style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                    <i className="bi bi-cloud-upload" style={{ fontSize: '20px', color: '#0d6efd' }}></i>
                    <span style={{ fontSize: '0.8rem', color: '#64748b' }}>{uploadedFiles.cin_recto || 'Télécharger le recto'}</span>
                  </label>
                </div>
              </div>
              ...
              <div style={{ marginBottom: '12px' }}>
                <label style={{ fontSize: '0.7rem', fontWeight: '500', color: '#475569', display: 'block', marginBottom: '4px' }}>
                  <i className="bi bi-card-image"></i> Carte d'identité (Verso)
                </label>
                <div style={{
                  border: '1.5px dashed #cbd5e1',
                  borderRadius: '12px',
                ...
                onMouseOut={e => e.currentTarget.style.borderColor = '#cbd5e1'}>
                  ...
                  <label htmlFor="cin_verso" style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                    <i className="bi bi-cloud-upload" style={{ fontSize: '20px', color: '#0d6efd' }}></i>
                    <span style={{ fontSize: '0.8rem', color: '#64748b' }}>{uploadedFiles.cin_verso || 'Télécharger le verso'}</span>
                  </label>
                </div>
              </div>
              ...
              <div style={{ marginBottom: '8px' }}>
                <label style={{ fontSize: '0.7rem', fontWeight: '500', color: '#475569', display: 'block', marginBottom: '4px' }}>
                  <i className="bi bi-file-earmark-pdf-fill"></i> Diplôme (PDF/JPG)
                </label>
                <div style={{
                  border: '1.5px dashed #cbd5e1',
                  borderRadius: '12px',
                ...
                onMouseOut={e => e.currentTarget.style.borderColor = '#cbd5e1'}>
                  ...
                  <label htmlFor="diplome" style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                    <i className="bi bi-cloud-upload" style={{ fontSize: '20px', color: '#0d6efd' }}></i>
                    <span style={{ fontSize: '0.8rem', color: '#64748b' }}>{uploadedFiles.diplome || 'Télécharger le diplôme'}</span>
                  </label>
                </div>
              </div>
            </div>
