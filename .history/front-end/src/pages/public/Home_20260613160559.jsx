...
export default function Home() {
  ...
  function triggerScrollSearch() {
    var element = document.getElementById('tutors-section');
    if (element) element.scrollIntoView({ behavior: 'smooth', block: 'start' });
  }
  ...
  return (
    <div className="pt-4">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-surface-card border border-hairline-strong rounded-3xl p-12 md:p-24 text-center relative overflow-hidden shadow-2xl">
            <div className="relative z-10 space-y-6 max-w-3xl mx-auto">
              ...
              <div className="pt-4">
                <button onClick={function() { setShowBecomeTutor(true); }} className="bg-ink text-canvas px-10 py-5 rounded-lg font-bold text-base hover:bg-ash transition-all shadow-xl cursor-pointer">Devenir Super Professeur</button>
      ...
      <FaqSection />
      {selectedTutor && <TutorDetailModal tutor={selectedTutor} onClose={function() { setSelectedTutor(null); }} onNewBooking={function() { alert('Réservation envoyée !'); }} />}
    </div>
  );
}