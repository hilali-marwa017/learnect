...
function Register() {
  ...
  const villesMaroc = [
    'Agadir', 'Ahfir', 'Ait Melloul', 'Al Hoceima', 'Azemmour', 'Azrou', 'Béni Mellal',
    'Casablanca', 'Fès', 'Marrakech', 'Meknès', 'Rabat', 'Tanger', 'Tétouan', 'Oujda',
    'Laayoune', 'Nador', 'Safi', 'Kenitra', 'El Jadida', 'Salé', 'Mohammedia', 'Khouribga',
    'Settat', 'Beni Mellal', 'Taza', 'Essaouira', 'Larache', 'Kénitra', 'Tiznit', 'Ouarzazate',
    'Dakhla', 'Guelmim', 'Taroudant', 'Chefchaouen', 'Ksar El Kebir', 'Errachidia', 'Ifrane'
  ];

  const niveauxEtudes = [
    { categorie: 'Préscolaire', niveaux: ['Préscolaire (3-5 ans)'] },
    { categorie: 'Primaire', niveaux: ['CP', 'CE1', 'CE2', 'CM1', 'CM2', '6ème primaire'] },
    { categorie: 'Collège', niveaux: ['Tronc Commun', '1ère année collège', '2ème année collège', '3ème année collège'] },
    { categorie: 'Lycée', niveaux: ['Tronc Commun Scientifique', 'Tronc Commun Lettres', '1ère année bac Sciences Maths', '1ère année bac Sciences Exp', '1ère année bac Lettres', '2ème année bac Sciences Maths A', '2ème année bac Sciences Maths B', '2ème année bac Sciences Physiques', '2ème année bac Sciences de la Vie et de la Terre', '2ème année bac Sciences Economiques', '2ème année bac Lettres'] },
    { categorie: 'Baccalauréat', niveaux: ['Baccalauréat (révision/ préparation)'] },
    { categorie: 'Université', niveaux: ['Licence 1 (DEUG)', 'Licence 2', 'Licence 3', 'Licence Professionnelle', 'Master 1', 'Master 2', 'Doctorat'] },
    { categorie: 'Grandes Écoles & Classes Préparatoires', niveaux: ['Classes Préparatoires (MPSI, PCSI, MP, PC, PSI)', 'École d\'Ingénieurs (1ère année)', 'École d\'Ingénieurs (2ème année)', 'École d\'Ingénieurs (3ème année)', 'École de Commerce (1ère année)', 'École de Commerce (2ème année)', 'École de Commerce (3ème année)'] },
    { categorie: 'Formation Professionnelle', niveaux: ['Technicien', 'Technicien Spécialisé', 'Formation Continue', 'BTS', 'DUT'] },
    { categorie: 'Langues & Soutien', niveaux: ['Français langue étrangère', 'Anglais', 'Espagnol', 'Allemand', 'Arabe pour non-arabophones', 'Soutien scolaire général'] },
    { categorie: 'Préparation Concours', niveaux: ['Concours de la fonction publique', 'Concours d\'entrée en médecine', 'Concours d\'entrée en école d\'ingénieurs', 'Concours d\'entrée en école de commerce', 'TOEIC/TOEFL/IELTS', 'DELF/DALF'] },
    { categorie: 'Autres', niveaux: ['Étudiant libre', 'Recyclage professionnel', 'Perfectionnement', 'Autre niveau'] }
  ];
            ...
            <div className="row g-2">
              <div className="col-12 mb-2">
                ...
                <div className="border border-dashed rounded-3 p-2 bg-light">
                  <input type="file" name="photo" accept="image/jpeg,image/png,image/jpg" onChange={handleFile} className="form-control form-control-sm border-0 py-1" />
                </div>
              ...
              <div className="col-12">
                ...
                <small className="text-muted">Vous pouvez taper ou choisir dans la liste</small>
              </div>
                ...
                <>
                  <div className="col-12">
                    ...
                    <select name="niveau" className="form-select form-select-sm py-2" value={form.niveau} onChange={handleChange}>
                      ...
                      {niveauxEtudes.map((categorie, idx) => (
                        <optgroup key={idx} label={categorie.categorie}>
                          {categorie.niveaux.map((niveau, idx2) => (
                            <option key={idx2} value={niveau}>{niveau}</option>
                          ))}
                        </optgroup>
                      ))}
                    </select>
                    <small className="text-muted">Choisissez votre niveau d'étude actuel</small>
                  </div>
                  <div className="col-12">
                    ...
                    <small className="text-muted">Budget maximum par heure pour un cours</small>
                  </div>
                </>
              )}
