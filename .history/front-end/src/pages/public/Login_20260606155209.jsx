    ...
    <div style={{minHeight: '100vh',background: 'white',display: 'flex',alignItems: 'center',justifyContent: 'center',padding: '24px'}}>
      <div style={{display: 'flex',maxWidth: '1000px',width: '100%',background: 'white',borderRadius: '24px',boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.15)',overflow: 'hidden'}}>
        ...
        <div style={{flex: 1,background: 'linear-gradient(135deg, #3c78d3, #0a58ca)',padding: '48px 40px',display: 'flex',flexDirection: 'column',justifyContent: 'space-between'}}>
          ...
          {/* Bouton retour */}
          <div className='fw-bold rounded-pill text-white text-decoration-none' >
            <Link to="/" 
              style={{display:'inline-flex',alignItems:'center',marginBottom: '20px' ,gap: '6px',color: 'white',textDecoration: 'none'}}><i className="bi bi-arrow-left"></i> Retour à l'accueil</Link>
          </div>
          ...
          <div>
            ...
            <div style={{display: 'flex',gap: '20px',marginTop: '20px'}}>
              <div>
                ...
                <div style={{ fontSize: '0.7rem', color: '#ffffff99' }}>Étudiants</div>
              </div>
              <div>
                <div style={{ fontSize: '24px', fontWeight: '800', color: 'white' }}>500+</div>
                <div style={{ fontSize: '0.7rem', color: '#ffffff99' }}>Professeurs</div>
              </div>
              <div>
                <div style={{ fontSize: '24px', fontWeight: '800', color: 'white' }}>4.9★</div>
                <div style={{ fontSize: '0.7rem', color: '#ffffff99' }}>Note moyenne</div>
              </div>
            </div>
          </div>
        ...
        {/* right part (formulaire) */}
        <div style={{flex: 1,padding: '48px 44px',background: 'white'}}>
          
          {/* header */}
          <div className='text-center'>
            <h3 className='fw-bold'style={{fontSize: '1.1rem',fontWeight: '700',color: '#1e293b',marginBottom: '4px'}}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '20px' }}>
              <label style={{display: 'block',marginBottom: '8px',fontWeight: '600',color: '#334155',fontSize: '0.75rem',letterSpacing: '0.5px'}}>
                ADRESSE EMAIL
              </label>
              ...
              <div style={{ position: 'relative' }}>
                <span style={{
                  position: 'absolute',left: '14px',top: '50%',transform: 'translateY(-50%)',fontSize: '1rem',color: '#94a3b8'}}>
