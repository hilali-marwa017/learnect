...
import { useAuth } from '../../context/AuthContext'; // CORRECTION : import useAuth
...
function Register() {
  ...
  const { register } = useAuth(); // CORRECTION : utiliser le contexte
  ...
  const handleSubmit = async (e) => {
    ...
    // CORRECTION : min 8 (cohérent avec AuthController.php 'min:8')
    ...
    try {
      ...
      // CORRECTION : utiliser register() du AuthContext
  ...
  // Page succès enseignant — inchangée
  if (success) {
    return (
            ...
            <div className="row g-2">
              ...
              {role === 'etudiant' && (
                <>
                  <div className="col-md-6">
                    <label className="form-label small fw-semibold text-secondary mb-1">
                      <i className="bi bi-book me-1"></i> Niveau d'étude
                    </label>
                  ...
                  <div className="col-md-6">
                    <label className="form-label small fw-semibold text-secondary mb-1">
                      <i className="bi bi-cash-stack me-1"></i> Budget (DH/h)
                    </label>
              ...
              <div className="col-md-6">
                ...
                <div className="position-relative">
                  <input type={showPass ? 'text' : 'password'} name="password" className="form-control form-control-sm py-2" placeholder="Min. 8 caractères" value={form.password} onChange={handleChange} required />
