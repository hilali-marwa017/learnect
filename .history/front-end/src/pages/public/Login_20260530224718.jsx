...
function Login() {
  ...
  const [showPassword, setShowPassword] = useState(false); // ✅ false = caché par défaut + œil barré
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
              ...
              >
                {/* 
                  showPassword = false → œil barré 👁️‍🗨️ → mot de passe caché (●●●●●●)
                  showPassword = true  → œil ouvert 👁️  → mot de passe visible (texte)
                */}
                {showPassword ? (
