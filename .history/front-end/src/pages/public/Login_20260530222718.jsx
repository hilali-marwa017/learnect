...
function Login() {
  ...
  const [showPassword, setShowPassword] = useState(true); // ✅ true = visible par défaut (œil ouvert)
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          ...
          <p style={{ color: '#6c757d', fontSize: '0.85rem', fontWeight: '500' }}>Authentification</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Champ Mot de passe - LOGIQUE CORRIGÉE */}
          <div style={{ marginBottom: '20px' }}>
            <label style={{ display: 'block', marginBottom: '8px', fontWeight: '600', color: '#374151', fontSize: '0.85rem' }}>
            ...
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
              ...
              >
                {/* 
                  showPassword = true  → œil ouvert 👁️  → mot de passe visible (text)
                  showPassword = false → œil barré 👁️‍🗨️ → mot de passe caché (password)
                */}
                {showPassword ? (
        ...
        <div style={{ textAlign: 'center', marginTop: '24px', paddingTop: '20px', borderTop: '1px solid #e9ecef' }}>
          ...
          <Link to="/" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', fontSize: '0.8rem', fontWeight: '500', color: '#94a3b8', textDecoration: 'none' }}>
