                        ...
                        <div className="card-body p-5 text-center">
                            ...
                            <div className="row g-4">
                                ...
                                <div className="col-md-6">
                                    <Link to="/register/etudiant" className="text-decoration-none">
                                        <div className="border rounded-4 p-4 text-center cursor-pointer transition-all hover-card">
                                ...
                                {/* Option Enseignant */}
                                <div className="col-md-6">
                                    <Link to="/register/enseignant" className="text-decoration-none">
                                        <div className="border rounded-4 p-4 text-center cursor-pointer transition-all hover-card">
                                            <div className="bg-primary bg-opacity-10 rounded-circle d-inline-flex align-items-center justify-content-center p-3 mb-3">
