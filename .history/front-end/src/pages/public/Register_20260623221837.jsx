  ...
  return (
    <div style={{ background: bg, minHeight: '100vh', padding: '0', position: 'relative' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
        ...
        {/* ── "Déjà un compte ? Se connecter" AVEC PLUS D'ESPACE ── */}
        <div style={{ 
          textAlign: 'center', 
          marginTop: '4rem',  // Augmenté de 3rem à 4rem
          paddingBottom: '2rem'  // Ajouté pour plus d'espace avant le footer
        }}>
          <p style={{ fontSize: '1rem', color: muted }}>
            Déjà un compte ?{' '}
            <span 
              style={{ 
                color: orange, 
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div>
              <h4 style={{ color: text, fontWeight: 700, marginBottom: '0.5rem' }}>EXPLORER</h4>
              <p style={{ color: muted, fontSize: '0.8rem', margin: '0.25rem 0' }}>Nos professeurs</p>
              <p style={{ color: muted, fontSize: '0.8rem', margin: '0.25rem 0' }}>Comment ça marche</p>
              <p style={{ color: muted, fontSize: '0.8rem', margin: '0.25rem 0' }}>FAQ</p>
              <p style={{ color: muted, fontSize: '0.8rem', margin: '0.25rem 0' }}>Devenir tuteur</p>
            </div>
            <div>
              <h4 style={{ color: text, fontWeight: 700, marginBottom: '0.5rem' }}>LÉGAL</h4>
              <p style={{ color: muted, fontSize: '0.8rem', margin: '0.25rem 0' }}>Conditions</p>
              <p style={{ color: muted, fontSize: '0.8rem', margin: '0.25rem 0' }}>Confidentialité</p>
              <p style={{ color: muted, fontSize: '0.8rem', margin: '0.25rem 0' }}>Mentions légales</p>
            </div>
            <div>
              <h4 style={{ color: text, fontWeight: 700, marginBottom: '0.5rem' }}>CONTACT</h4>
              <p style={{ color: muted, fontSize: '0.8rem', margin: '0.25rem 0' }}>contact@learnect.ma</p>
              <p style={{ color: muted, fontSize: '0.8rem', margin: '0.25rem 0' }}>+212 522 123 456</p>
              <p style={{ color: muted, fontSize: '0.8rem', margin: '0.25rem 0' }}>Casablanca, Maroc</p>
            </div>
          </div>
