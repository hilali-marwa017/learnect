...
export default function Home() {
  ...
  const user = context ? context.user : null; // ✅ user réel depuis le context
  ...
  // Filtrage avec prise en charge de "Webcam"
  ...
  return (
    <div>
      ...
      <TeachersSection
        ...
        queryCity={queryCity}
        user={user} // ✅ passé au TeachersSection → TeacherCard
      />
      <StatsSection isDark={isDark} />
      <HowItWorks isDark={isDark} />
      <FeaturesSection isDark={isDark} />
      <CtaSection isDark={isDark} user={user} /> {/* ✅ user réel */}
