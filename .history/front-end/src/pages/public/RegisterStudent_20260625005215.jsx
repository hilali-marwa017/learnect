...
export default function RegisterStudent() {
  ...
  // Filtre les villes selon ce que l'utilisateur tape
  function getFilteredCities() {
    if (!form.ville) return CITIES
    return CITIES.filter(c => c.toLowerCase().includes(form.ville.toLowerCase()))
  }
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: bgSurf, border: `1px solid ${errors.budget ? '#e24b4a' : bdr}`, borderRadius: 10, padding: '12px 14px' }}>
                      ...
                      <input type="number" name="budget" min="0" step="10" value={form.budget} onChange={handleChange}
                        style={{ background: 'none', border: 'none', outline: 'none', color: ink, fontSize: '0.85rem', width: '100%' }} />
