...
import { GraduationCap, UserPlus, BookOpen, Users, CheckCircle, ArrowRight } from 'lucide-react';
...
export default function Register() {
  ...
  useEffect(() => {
    const savedTheme = localStorage.getItem('learnect_theme');
  ...
  return (
    <div style={{ background: bg, minHeight: '100vh', padding: '4rem 2rem' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginBottom: '1rem' }}>
            ...
            <span style={{ fontWeight: 800, fontSize: '1.3rem', color: text }}>Learn<span style={{ color: orange }}>ect</span>.ma</span>
          </div>
          <h1 style={{ fontSize: '2.5rem', fontWeight: 700, color: text, marginBottom: '0.5rem' }}>COMMENCEZ DÈS AUJOURD'HUI</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '1.5rem' }}>
              ...
              <div>
                <h3 style={{ fontSize: '1.3rem', fontWeight: 700, color: text, margin: 0 }}>Je suis un Élève / Étudiant</h3>
              </div>
            </div>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '1.5rem' }}>
              ...
              <div>
                <h3 style={{ fontSize: '1.3rem', fontWeight: 700, color: text, margin: 0 }}>Je suis un Enseignant / Tuteur</h3>
              </div>
            </div>
            <p style={{ color: muted, fontSize: '0.9rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '3rem', paddingTop: '2rem', borderTop: `1px solid ${border}` }}>
          <p style={{ fontSize: '0.8rem', color: muted }}>
            Déjà un compte ? <span style={{ color: orange, cursor: 'pointer' }} onClick={() => navigate('/login')}>Se connecter</span>
          </p>
        </div>
      </div>
