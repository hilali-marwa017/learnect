...
function Register() {
  ...
  // État pour afficher les noms des fichiers uploadés
  ...
  const validateForm = () => {
    ...
    if (role === 'enseignant') {
      ...
      if (!form.cin_recto || !form.cin_verso || !form.diplome) {
        setError('Veuillez télécharger tous les documents requis (CIN recto/verso, diplôme)');
        return false;
      }
    }
    setError('');
    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{
                ...
                onMouseOut={e => e.currentTarget.style.borderColor = '#cbd5e1'}>
                  ...
                  <label htmlFor="cin_recto" style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                    ...
                    <span style={{ fontSize: '0.8rem', color: '#64748b' }}>
                      {uploadedFiles.cin_recto || 'Télécharger le recto'}
                    </span>
                  </label>
                </div>
              </div>
              ...
              <div style={{ marginBottom: '12px' }}>
                ...
                onMouseOut={e => e.currentTarget.style.borderColor = '#cbd5e1'}>
                  ...
                  <label htmlFor="cin_verso" style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                    <i className="bi bi-cloud-upload" style={{ fontSize: '20px', color: '#0d6efd' }}></i>
                    <span style={{ fontSize: '0.8rem', color: '#64748b' }}>
                      {uploadedFiles.cin_verso || 'Télécharger le verso'}
                    </span>
                  </label>
                </div>
              </div>
              ...
              <div style={{ marginBottom: '8px' }}>
                ...
                onMouseOut={e => e.currentTarget.style.borderColor = '#cbd5e1'}>
                  ...
                  <label htmlFor="diplome" style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                    <i className="bi bi-cloud-upload" style={{ fontSize: '20px', color: '#0d6efd' }}></i>
                    <span style={{ fontSize: '0.8rem', color: '#64748b' }}>
                      {uploadedFiles.diplome || 'Télécharger le diplôme'}
                    </span>
                  </label>
                </div>
              </div>
          ...
          {/* Mot de passe avec œil (comme Login) */}
