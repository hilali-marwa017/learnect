...
import { 
  ...
  FileText, Image, ChevronRight, AlertCircle
} from 'lucide-react';
...
function Register(props) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (isEnseignant) {
        ...
        formData.append('tarifHeure', form.tarifHeure);
        formData.append('diplome_title', form.diplomeTitle);
  ...
  // Écran de soumission pour enseignant
  if (isSubmitted) {
    return (
        ...
        <div className="col-12 col-md-10 col-lg-8">
          <div className="card shadow-sm border-0 rounded-4 overflow-hidden">
            ...
            <div className="card-body p-4 p-md-5">
              ...
              {/* Role Selection - Style comme Superprof */}
              {etape === 1 && (
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="border rounded-3 p-4 text-center bg-light">
                        <Image size={32} className="text-primary mx-auto mb-2 d-block" />
                        {uploadedFiles.cin_recto ? (
                          <div>
                            <span className="badge bg-success mb-2">✓ {uploadedFiles.cin_recto}</span>
                            <button type="button" onClick={() => simulateUpload('recto')} className="btn btn-sm btn-outline-secondary w-100 mt-2">
                              Changer
                            </button>
                          </div>
                        ) : (
                      ...
                      <div className="border rounded-3 p-4 text-center bg-light">
                        ...
                        {uploadedFiles.cin_verso ? (
                          <div>
                            ...
                            <button type="button" onClick={() => simulateUpload('verso')} className="btn btn-sm btn-outline-secondary w-100 mt-2">
                              Changer
                            </button>
                          </div>
                        ) : (
                    ...
                    <div className="col-12">
                      ...
                      <div className="border rounded-3 p-4 text-center bg-light">
                        <FileText size={32} className="text-primary mx-auto mb-2 d-block" />
                        {uploadedFiles.diplome ? (
                          <div>
                            <span className="badge bg-success mb-2">✓ {uploadedFiles.diplome}</span>
                            <button type="button" onClick={() => simulateUpload('diplome')} className="btn btn-sm btn-outline-secondary w-100 mt-2">
                              Changer
                            </button>
                          </div>
                        ) : (
                    ...
                    <div className="col-12 mt-3">
                      <div className="d-flex gap-3">
                        <button type="button" onClick={() => setEtape(1)} className="btn btn-outline-secondary flex-grow-1 py-2 rounded-3">
                          Retour
                        </button>
