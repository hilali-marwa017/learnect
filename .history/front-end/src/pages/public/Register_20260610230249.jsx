    ...
    return (
      <div style={{ minHeight: '100vh', background: '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ maxWidth: '400px', background: 'white', borderRadius: '16px', padding: '24px', textAlign: 'center' }}>
          ...
          <Link to="/login" style={{ display: 'block', background: '#0d6efd', color: 'white', textAlign: 'center', padding: '10px', borderRadius: '8px', ...linkStyle }}>Se connecter</Link>
        </div>
      </div>
    );
  }
      ...
      <div style={{ maxWidth: '500px', width: '100%', background: 'white', borderRadius: '16px' }}>
        <div style={{ padding: '24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '16px' }}>
            <Link to="/" style={{ color: '#6B7280', ...linkStyle }}>
              ...
              <>
                ...
                <div style={{ marginBottom: '12px' }}>
                  ...
                  <datalist id="villes-list">
                    {villes.map((v, idx) => <option key={idx} value={v.nom} />)}
                  </datalist>
                </div>
                  ...
                  <>
                    <div style={{ marginBottom: '12px' }}>
                      ...
                      <select name="niveau" style={{ width: '100%', padding: '8px 12px', border: '1px solid #E2E8F0', borderRadius: '8px', background: 'white' }} value={form.niveau} onChange={handleChange}>
                        ...
                        {niveaux.map((n, idx) => <option key={idx} value={n}>{n}</option>)}
                      </select>
                    </div>
                    <div style={{ marginBottom: '12px' }}>
                  ...
                  <>
                    <div style={{ marginBottom: '12px' }}>
                      ...
                      <datalist id="matieres-list">
                        {matieres.map((m, idx) => <option key={idx} value={m.nom} />)}
                      </datalist>
                    </div>
                    <div style={{ marginBottom: '12px' }}>
                ...
                <button type="submit" style={{ width: '100%', padding: '10px', background: '#0d6efd', color: 'white', border: 'none', borderRadius: '8px', fontWeight: 'bold', ...noHoverStyle }}>
            ...
            {role === 'enseignant' && step === 2 && (
              <>
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                  <button type="button" style={{ flex: 1, padding: '10px', background: '#f1f5f9', border: '1px solid #E2E8F0', borderRadius: '8px', ...noHoverStyle }} onClick={() => { setStep(1); setError(''); }}>
                    ← Retour
                  </button>
                  <button type="submit" style={{ flex: 2, padding: '10px', background: '#0d6efd', color: 'white', border: 'none', borderRadius: '8px', fontWeight: 'bold', ...noHoverStyle }} disabled={loading}>
          ...
          <div style={{ textAlign: 'center', fontSize: '12px' }}>
            ...
            <Link to="/login" style={{ color: '#0d6efd', ...linkStyle, marginLeft: '6px', fontWeight: 'bold' }}>Se connecter</Link>
          </div>
        </div>
      </div>
    </div>
