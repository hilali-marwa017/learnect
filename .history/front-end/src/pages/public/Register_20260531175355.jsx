  ...
  if (success) {
    return (
      <div className="container d-flex align-items-center justify-content-center" style={{ minHeight: '100vh' }}>
        <div className="card border-0 shadow-lg rounded-4 p-4" style={{ maxWidth: '420px', width: '100%' }}>
        ...
        <div className="card-body p-4">
          ...
          <div className="text-center mb-4">
            <Link to="/" className="text-decoration-none">
              <div className="d-flex align-items-center justify-content-center gap-2 mb-2">
                <div className="bg-primary text-white rounded-2 d-flex align-items-center justify-content-center" style={{ width: '36px', height: '36px' }}>
                  <i className="bi bi-mortarboard fs-6"></i>
                </div>
            ...
            <div className={`badge bg-${role === 'enseignant' ? 'success' : 'primary'} bg-opacity-10 text-${role === 'enseignant' ? 'success' : 'primary'} rounded-pill px-3 py-1 d-inline-flex align-items-center gap-1 mb-2`}>
              <i className={`bi ${role === 'enseignant' ? 'bi-briefcase' : 'bi-mortarboard'} fs-6`}></i>
            ...
            <div className="row g-2">
              <div className="col-md-6">
                <label className="form-label small fw-semibold text-secondary mb-1">
                  <i className="bi bi-person text-primary me-1"></i>Nom
                </label>
              ...
              <div className="col-md-6">
                <label className="form-label small fw-semibold text-secondary mb-1">
                  <i className="bi bi-person-badge text-primary me-1"></i>Prénom
                </label>
              ...
              <div className="col-md-6">
                ...
                <div className="password-wrapper position-relative">
                  ...
                  <button type="button" className="password-toggle position-absolute end-0 top-50 translate-middle-y bg-transparent border-0 text-muted me-2" onClick={() => setShowPass(!showPass)}>
              ...
              <div className="col-md-6">
                <label className="form-label small fw-semibold text-secondary mb-1">
                  <i className="bi bi-lock-fill text-primary me-1"></i>Confirmer
                </label>
                <div className="password-wrapper position-relative">
                  ...
                  <button type="button" className="password-toggle position-absolute end-0 top-50 translate-middle-y bg-transparent border-0 text-muted me-2" onClick={() => setShowPass2(!showPass2)}>
              ...
              {role === 'enseignant' && (
                <div className="col-12">
                  <div className="bg-light rounded-3 p-3 mt-2">
                    ...
                    <div className="mb-2">
                      <label className="form-label small fw-semibold text-secondary mb-1">
                        <i className="bi bi-credit-card text-primary me-1"></i>CIN Recto
                      </label>
                    ...
                    <div className="mb-2">
                      <label className="form-label small fw-semibold text-secondary mb-1">
                        <i className="bi bi-credit-card-2-back text-primary me-1"></i>CIN Verso
                      </label>
                      <div className="border border-dashed rounded-3 p-2 bg-white d-flex align-items-center gap-2">
                        <i className="bi bi-image text-primary"></i>
                    ...
                    <div className="mb-2">
                      <label className="form-label small fw-semibold text-secondary mb-1">
                        <i className="bi bi-file-earmark-pdf text-danger me-1"></i>Diplôme
                      </label>
                      <div className="border border-dashed rounded-3 p-2 bg-white d-flex align-items-center gap-2">
                    ...
                    <div className="mt-2 p-2 bg-white rounded-3 d-flex gap-2">
                      <i className="bi bi-info-circle text-muted fs-6"></i>
                      <small className="text-muted">Vérification sous <strong>24h</strong>.</small>
                    </div>
                  </div>
                </div>
              )}
