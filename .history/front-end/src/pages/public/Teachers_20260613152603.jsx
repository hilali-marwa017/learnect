      ...
      <div className="max-w-7xl mx-auto px-6 space-y-8 animate-in fade-in duration-300">
        ...
        {filteredTutors.length > 0 ? (
          ...
          <div className="text-center py-20 bg-surface-card border border-hairline rounded-xl max-w-xl mx-auto space-y-4 p-8">
            <i className="bi bi-search text-4xl text-mute block"></i>
            ...
            <button onClick={function() { setQuerySubject(''); setQueryCity(''); setActiveSubjectFilter(null); }} className="bg-ink text-canvas hover:bg-ash p-2.5 px-6 rounded-lg text-xs font-bold transition-all">
