  ...
  const handleSubmit = (e) => {
    ...
    fetch(url, { method: 'POST', body: data })
      ...
      .then(result => {
        ...
        if (role === 'enseignant') {
          // Stocker les infos pour le formulaire complémentaire
          localStorage.setItem('temp_teacher', JSON.stringify({
            email: form.email,
            ville: form.ville,
            nom: form.nom,
            prenom: form.prenom,
            telephone: form.telephone,
            userId: result.user.utilisateur_id
          }));
            ...
            {role === 'enseignant' && (
              <div style={{ marginTop: '15px', textAlign: 'center' }}>
                <p style={{ fontSize: '12px', color: '#666' }}>
                  ...
                  Vous serez redirigé vers un formulaire complémentaire
                </p>
              </div>
            )}
          </form>
