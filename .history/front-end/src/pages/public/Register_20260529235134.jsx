          ...
          <div className="card shadow-lg border-0 rounded-4 p-4 p-md-5 bg-white position-relative overflow-hidden">
            ...
            <div className="card-body p-0 text-center">
              ...
              <div className="row g-4 justify-content-center">
                ...
                {/* Profil Élève - Carte entièrement cliquable */}
                <div className="col-md-6">
                  ...
                  >
                    ...
                    <button 
                      ...
                      style={{ borderRadius: '10px', fontSize: '14px', pointerEvents: 'none' }}
                    >
                      Trouver un tuteur →
                    </button>
                  </div>
                ...
                {/* Profil Professeur - Carte entièrement cliquable */}
                <div className="col-md-6">
                  <div 
                  ...
                  >
                    ...
                    <button 
                      ...
                      style={{ borderRadius: '10px', fontSize: '14px', background: '#059669', pointerEvents: 'none' }}
                    >
                      Donner des cours →
                    </button>
                  </div>
