...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* SECTION 2: TEACHERS - Accès direct aux profils et résultats des filtres */}
      <TeachersSection
        isDark={isDark}
      ...
      {/* SECTION 3: STATS - Valide et renforce ("450+ tuteurs comme ça au Maroc") */}
      <StatsSection isDark={isDark} />

      {/* SECTION 4: HOW IT WORKS - Explique comment réserver un prof */}
      <HowItWorks isDark={isDark} />

      {/* SECTION 5: FEATURES - Détaille les fonctionnalités clés */}
      <FeaturesSection isDark={isDark} />

      {/* SECTION 6: CTA - Relance l'inscription */}
      <CtaSection isDark={isDark} user={null} />

      {/* SECTION 7: FAQ - Élimine les dernières questions */}
