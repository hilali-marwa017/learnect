            ...
            <div className="row g-3">
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="border rounded-3 p-2 bg-white">
                        <input type="file" name="cin_recto" accept="image/*" className="form-control form-control-sm"
                          onChange={(e) => handleFichier(e, 'cin_recto')} required />
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="border rounded-3 p-2 bg-white">
                        <input type="file" name="cin_verso" accept="image/*" className="form-control form-control-sm"
                          onChange={(e) => handleFichier(e, 'cin_verso')} required />
                        <small className="text-muted">JPG/PNG — Max 2MB</small>
                      </div>
                    </div>
                    ...
                    <div className="col-12">
                      ...
                      <div className="border rounded-3 p-2 bg-white">
                        <input type="file" name="diplome" accept=".pdf" className="form-control form-control-sm"
                          onChange={(e) => handleFichier(e, 'diplome')} required />
              ...
              <div className="col-12">
                <div className="bg-light rounded-3 p-2 d-flex gap-2 align-items-center">
                  ...
                  <span className="small text-muted">Vérification sous <strong>24h</strong> après soumission</span>
                </div>
              </div>
              ...
              <div className="col-12">
                <div className="form-check py-2">
                  ...
                  />
                  <label className="form-check-label small text-muted ms-2" htmlFor="certification">
