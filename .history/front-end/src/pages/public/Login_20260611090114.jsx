...
function Login() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      console.log('1. Utilisateur reçu:', utilisateur);
      console.log('2. Role:', utilisateur.role);
      console.log('3. Statut:', utilisateur.statut);
      
      // Vérifier le rôle et rediriger
      if (utilisateur.role === 'admin') {
        console.log('4. Redirection vers /admin/dashboard');
        navigate('/admin/dashboard');
      } 
      else if (utilisateur.role === 'enseignant') {
        console.log('4. Redirection vers /enseignant/dashboard');
        navigate('/enseignant/dashboard');
      } 
      else if (utilisateur.role === 'etudiant') {
        console.log('4. Redirection vers /etudiant/dashboard');
        navigate('/etudiant/dashboard');
      }
      else {
        console.log('4. Role non reconnu:', utilisateur.role);
      ...
      console.error('Message erreur:', err.response?.data?.message);
        ...
        <div style={{ flex: 1, padding: '48px 44px', background: 'white' }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ textAlign: 'right', marginBottom: '16px' }}>
              <span style={{ fontSize: '0.7rem', color: '#94a3b8', cursor: 'default' }}>Mot de passe oublié ?</span>
            </div>
