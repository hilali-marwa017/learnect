...
export default function Login() {
  ...
  const bgLeft = isDark ? '#0a0a0c' : '#0a0a0c';
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '0.6rem', color: '#888', letterSpacing: '0.12em', textTransform: 'uppercase' }}>
          ...
          {/* Tagline */}
          <div>
            <h2 style={{ fontSize: '1.6rem', fontWeight: 800, color: '#fff', lineHeight: 1.3, margin: 0 }}>
              Réussissez vos examens<br />avec nos tuteurs d'élite.
            </h2>
            <p style={{ fontSize: '0.85rem', color: '#888', lineHeight: 1.6, margin: '0.75rem 0 0 0' }}>
        ...
        <div style={{ padding: '3rem 2.5rem', display: 'flex', flexDirection: 'column', justifyContent: 'center', background: bgRight }}>
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            <h1 style={{ fontSize: '1.8rem', fontWeight: 800, color: textColor, marginBottom: '0.4rem' }}>
          ...
          <div style={{ marginBottom: '1.2rem' }}>
            <label style={{ display: 'block', fontSize: '0.7rem', fontWeight: 700, color: textMuted, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '8px' }}>
              Adresse Email
            </label>
            <div style={{ position: 'relative' }}>
              <Mail size={15} color={textMuted} style={{ position: 'absolute', left: '14px', top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }} />
              <input
                type="email"
                value={email}
          ...
          <div style={{ marginBottom: '1.8rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
              <label style={{ fontSize: '0.7rem', fontWeight: 700, color: textMuted, textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                Mot de passe
              </label>
              <span style={{ fontSize: '0.78rem', color: orange, cursor: 'pointer' }}>Perdu ?</span>
            </div>
            <div style={{ position: 'relative' }}>
              <Lock size={15} color={textMuted} style={{ position: 'absolute', left: '14px', top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }} />
              <input
              ...
              <button
                ...
                style={{
                  ...
                  color: showPassword ? orange : textMuted,
          ...
          <button
            ...
            style={{
              width: '100%',
              background: isDark ? '#1a1a1c' : '#0a0a0c',
              color: '#fff',
              border: 'none',
              borderRadius: '10px',
              padding: '14px',
          ...
          <p style={{ textAlign: 'center', fontSize: '0.82rem', color: textMuted, margin: 0 }}>
            Pas encore adhérent ?{' '}
