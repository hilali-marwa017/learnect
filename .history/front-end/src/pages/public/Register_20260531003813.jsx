    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{
          ...
          transform: isToggling ? 'translateY(8px)' : 'translateY(0)',
        }}>
          ...
          {/* SECTION ENSEIGNANT AVEC ANIMATION D'APPARITION */}
          <div style={{
            transition: 'all 0.3s ease-in-out',
            maxHeight: role === 'enseignant' ? '800px' : '0',
            opacity: role === 'enseignant' ? 1 : 0,
            overflow: 'hidden',
            marginBottom: role === 'enseignant' ? '20px' : '0',
          }}>
            {role === 'enseignant' && (
              <div style={{
          ...
          {/* Mot de passe avec œil - COMME DANS LOGIN */}
