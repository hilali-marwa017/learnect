              ...
              <>
                ...
                <div style={{ marginBottom: '15px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
                    <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                      ...
                      <span><i className="bi bi-laptop me-1"></i>En ligne (webcam)</span>
                    </label>
                    <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                  ...
                  <small style={{ color: '#666' }}>Sélectionnez au moins une option</small>
                </div>
                ...
                {checkboxes.cours_deplacement && (
                  <div style={{ marginBottom: '15px' }}>
                    ...
                    <small style={{ color: '#666' }}>Distance maximale que vous pouvez parcourir</small>
                  </div>
                )}
                ...
                <div style={{ marginBottom: '15px' }}>
                  ...
                  <small style={{ color: '#666' }}>Séparez par des virgules</small>
                </div>
