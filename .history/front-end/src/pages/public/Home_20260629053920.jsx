// ============================================================
// Home.jsx — CORRIGÉ : Filtre matière UNIQUEMENT dans matieres.nom
// ============================================================
...
export default function Home() {
  ...
  // ============================================================
  // SECTION 2 : FILTRAGE (matières UNIQUEMENT + ville/webcam)
  // ============================================================
  useEffect(() => {
    let result = [...allTutors];

    // --- Filtre par matière UNIQUEMENT (pas langues, pas titre) ---
    if (querySubject) {
      const search = querySubject.toLowerCase().trim();
      result = result.filter(t => {
        const matieres = (t.matieres || [])
          .map(m => (m.nom || '').toLowerCase());
        // ✅ UNIQUEMENT dans les matières enseignées
