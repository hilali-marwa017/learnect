    ...
    <div className="min-h-screen flex items-center justify-center pt-24 pb-16 bg-canvas px-4">
      <div className="relative w-full max-w-4xl bg-surface-card border border-hairline-strong rounded-2xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-12 min-h-[500px]">
        ...
        <div className="md:col-span-12 lg:col-span-7 p-8 md:p-12 flex flex-col justify-center relative bg-surface-card">
          <Link to="/" className="absolute top-6 right-6 p-2 rounded-full border border-hairline bg-surface-card hover:bg-surface-elevated text-charcoal hover:text-ink transition-all flex items-center justify-center hover:scale-105">
            <X className="h-4 w-4" />
          </Link>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input required type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="email@exemple.ma" className="w-full bg-surface-deep/50 border border-hairline-strong text-ink rounded-lg pl-10 pr-4 py-2.5 text-xs focus:ring-1 focus:ring-accent-orange outline-none" />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input required type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="w-full bg-surface-deep/50 border border-hairline-strong text-ink rounded-lg pl-10 pr-10 py-2.5 text-xs focus:ring-1 focus:ring-accent-orange outline-none" />
                ...
                <button type="submit" disabled={loading} className="w-full bg-ink text-canvas hover:bg-accent-orange hover:text-white py-3 px-4 rounded-lg text-xs font-bold font-mono tracking-wider transition-all cursor-pointer flex items-center justify-center gap-2">
                  {loading ? <div className="spinner-border spinner-border-sm"></div> : <><LogIn className="h-4 w-4" /><span>OUVRIR MA SESSION</span></>}
                </button>
              </form>
            )}
