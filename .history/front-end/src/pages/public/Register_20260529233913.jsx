            ...
            <div className="card shadow-sm border-0 rounded-4">
              <div className="card-body p-5">
                ...
                <div className="text-center mb-4">
                  ...
                  <p className="text-muted">Félicitations <strong>{form.prenom} {form.nom}</strong>. Votre demande de certification est bien enregistrée.</p>
                </div>
  ...
  return (
    <div className="container py-5">
          ...
          <div className="card shadow-sm border-0 rounded-4">
            <div className="card-body p-4 p-md-5">
              ...
              <div className="text-center mb-4">
                ...
                <h2 className="fw-bold mb-2" style={{ fontSize: '1.8rem' }}>Inscription Learnect.ma</h2>
                <p className="text-muted">Rejoignez le réseau marocain d'entraide et soutien scolaire</p>
              </div>
              ...
              {etape === 1 && (
                <div className="row g-3 mb-4">
                  <div className="col-md-6">
                    <div onClick={() => handleRoleChange('etudiant')} className={`border rounded-3 p-3 text-center cursor-pointer transition-all ${form.role === 'etudiant' ? 'border-primary bg-primary bg-opacity-5' : 'border-secondary'}`}>
                  ...
                  <div className="col-md-6">
                    <div onClick={() => handleRoleChange('enseignant')} className={`border rounded-3 p-3 text-center cursor-pointer transition-all ${form.role === 'enseignant' ? 'border-primary bg-primary bg-opacity-5' : 'border-secondary'}`}>
                ...
                {etape === 1 && (
                  <div className="row g-4">
                    ...
                    <div className="col-12">
                      <label className="form-label fw-semibold small text-uppercase text-secondary">ADRESSE EMAIL</label>
                      <div className="input-group">
                    ...
                    <div className="col-md-6">
                      <label className="form-label fw-semibold small text-uppercase text-secondary">TÉLÉPHONE (WHATSAPP)</label>
                      <div className="input-group">
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="input-group">
                        <span className="input-group-text bg-light border-end-0"><i className="bi bi-geo-alt text-muted"></i></span>
                    ...
                    <div className="col-md-6">
                      <label className="form-label fw-semibold small text-uppercase text-secondary">MOT DE PASSE CONFIDENTIEL</label>
                      <div className="input-group">
                    ...
                    <div className="col-md-6">
                      <label className="form-label fw-semibold small text-uppercase text-secondary">CONFIRMER MOT DE PASSE</label>
                      <div className="input-group">
                    ...
                    {isEnseignant && (
                      <>
                        <div className="col-md-7">
                          ...
                          <div className="input-group">
                            <span className="input-group-text bg-light border-end-0"><i className="bi bi-book text-muted"></i></span>
                    ...
                    <div className="col-12 mt-3">
                      <button type="submit" className="btn btn-primary w-100 py-3 fw-bold d-flex align-items-center justify-content-center gap-2" style={{ borderRadius: '12px', fontSize: '15px' }} disabled={isLoading}>
                        {isLoading ? (
                ...
                {isEnseignant && etape === 2 && (
                  <div className="row g-4">
                    <div className="col-12">
                      ...
                      <div className="input-group">
                        <span className="input-group-text bg-light"><i className="bi bi-award text-primary"></i></span>
                        <input type="text" name="diplomeTitle" value={form.diplomeTitle} onChange={handleChange} className="form-control" placeholder="Ex: Master en Énergétique, Licence Pro" required />
                      </div>
                    </div>
                    ...
                    <div className="col-md-6">
                      <div className="border rounded-3 p-4 text-center bg-light">
                        ...
                        {uploadedFiles.cin_recto ? (
                          <><span className="badge bg-success"><i className="bi bi-check-circle me-1"></i> {uploadedFiles.cin_recto}</span>
                          <button type="button" onClick={() => simulateUpload('recto')} className="btn btn-sm btn-link text-primary mt-2 d-block mx-auto">Changer</button></>
                        ) : (
                          <button type="button" onClick={() => simulateUpload('recto')} className="btn btn-outline-primary" disabled={uploadingRecto}>
                            {uploadingRecto ? "Dépose en cours..." : <><i className="bi bi-cloud-upload me-2"></i>Simuler téléversement</>}
                          </button>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="col-md-6">
                      <div className="border rounded-3 p-4 text-center bg-light">
                        ...
                        {uploadedFiles.cin_verso ? (
                          <><span className="badge bg-success"><i className="bi bi-check-circle me-1"></i> {uploadedFiles.cin_verso}</span>
                          <button type="button" onClick={() => simulateUpload('verso')} className="btn btn-sm btn-link text-primary mt-2 d-block mx-auto">Changer</button></>
                        ) : (
                          <button type="button" onClick={() => simulateUpload('verso')} className="btn btn-outline-primary" disabled={uploadingVerso}>
                            {uploadingVerso ? "Dépose en cours..." : <><i className="bi bi-cloud-upload me-2"></i>Simuler téléversement</>}
                          </button>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="col-12">
                      <div className="border rounded-3 p-4 text-center bg-light">
                        ...
                        <div className="fw-bold mb-2">Diplôme (PDF ou JPG)</div>
                        {uploadedFiles.diplome ? (
                          <><span className="badge bg-success"><i className="bi bi-check-circle me-1"></i> {uploadedFiles.diplome}</span>
                          <button type="button" onClick={() => simulateUpload('diplome')} className="btn btn-sm btn-link text-primary mt-2 d-block mx-auto">Changer</button></>
                        ) : (
                          <button type="button" onClick={() => simulateUpload('diplome')} className="btn btn-outline-primary" disabled={uploadingDiplome}>
                            {uploadingDiplome ? "Dépose en cours..." : <><i className="bi bi-cloud-upload me-2"></i>Simuler téléversement</>}
                          </button>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="col-12">
                      <div className="d-flex gap-3">
                        <button type="button" onClick={() => setEtape(1)} className="btn btn-outline-secondary flex-grow-1 py-3 fw-bold" style={{ borderRadius: '12px' }}>
                          <i className="bi bi-arrow-left me-2"></i> Retour
                        </button>
                        <button type="submit" className="btn btn-primary flex-grow-1 py-3 fw-bold d-flex align-items-center justify-content-center gap-2" style={{ borderRadius: '12px' }} disabled={isLoading || !uploadedFiles.cin_recto || !uploadedFiles.cin_verso || !uploadedFiles.diplome}>
                          {isLoading ? "Traitement..." : <><i className="bi bi-send-check"></i> SOUMETTRE MON DOSSIER</>}
                        </button>
                      </div>
                    </div>
                  </div>
      ...
      <style>{`
        ...
        .btn-primary:hover { background-color: #0b5ed7 !important; border-color: #0b5ed7 !important; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(13,110,253,0.3); }
        ...
        .card:hover { transform: translateY(-4px); box-shadow: 0 20px 35px -12px rgba(0,0,0,0.1) !important; }
      `}</style>
    </div>
  );
}

export default Register;x``