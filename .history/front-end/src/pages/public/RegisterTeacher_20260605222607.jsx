            ...
            <div className="row g-3">
              ...
              <div className="col-12 mt-2">
                <div className="bg-light p-3 rounded-3">
                  <p className="fw-semibold small mb-2"><i className="bi bi-shield-check me-1"></i>Documents requis</p>
                  
                  <div className="row g-2">
                    <div className="col-6">
                      <label className="form-label small">CIN Recto</label>
                      <input type="file" name="cin_recto" accept="image/*"
                        className="form-control form-control-sm" onChange={handleFichier} required />
                    ...
                    <div className="col-12">
                      <label className="form-label small">Diplôme</label>
