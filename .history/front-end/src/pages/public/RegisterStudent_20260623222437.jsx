...
function Field({ label, icon: Icon, name, type = 'text', placeholder, value, onChange, error, showToggle, onToggle, showPass, isDark }) {
      ...
      <div style={{
        ...
        {showToggle && (
          <button
            type="button"
            onClick={onToggle}
            style={{ background: 'none', border: 'none', cursor: 'pointer', color: dimmed, padding: 0, display: 'flex', alignItems: 'center', flexShrink: 0 }}
          >
          ...
          <form onSubmit={handleSubmit} style={{ padding: '2rem' }}>
            ...
            {step === 1 && (
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                <Field label="Prénom" icon={User} name="prenom" placeholder="Ex: Amine" value={form.prenom} onChange={handleChange} error={errors.prenom} isDark={isDark} />
                <Field label="Nom" icon={User} name="nom" placeholder="Ex: Benjelloun" value={form.nom} onChange={handleChange} error={errors.nom} isDark={isDark} />
                ...
                <Field label="Téléphone portable" icon={Phone} name="telephone" placeholder="Ex: +212 661-234567" value={form.telephone} onChange={handleChange} error={errors.telephone} isDark={isDark} />
                    ...
                    <div style={{
                      ...
                      {getFilteredCities().map(city => (
                        <div
                          ...
                          style={{ padding: '10px 14px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 10, fontSize: '0.85rem', color: ink }}
                ...
                <div style={{ gridColumn: '1 / -1', display: 'flex', justifyContent: 'flex-end', marginTop: '1rem' }}>
                  <button type="button" onClick={handleNext}
                    style={{ background: ink, color: bg, border: 'none', borderRadius: 10, padding: '12px 32px', fontWeight: 700, fontSize: '0.85rem', cursor: 'pointer' }}>
                    Continuer
                  </button>
                </div>
              </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: bgSurf, border: `1px solid ${errors.budget ? '#e24b4a' : bdr}`, borderRadius: 10, padding: '12px 14px' }}>
                      ...
                      <input type="number" name="budget" min="0" step="10" value={form.budget} onChange={handleChange} placeholder="Ex: 150"
                        style={{ background: 'none', border: 'none', outline: 'none', color: ink, fontSize: '0.85rem', width: '100%' }} />
