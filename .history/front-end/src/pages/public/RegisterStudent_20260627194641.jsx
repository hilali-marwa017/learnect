...
export default function RegisterStudent() {
  ...
  // ✅ NOUVEAU : gestion photo de profil
  ...
  // ✅ CORRIGE : utilise registerMultipart() du AuthContext -> met à jour le user du contexte
  // -> isAuthenticated devient true -> plus de redirection vers Home
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (resultat.success) {
        ...
        setError(resultat.message || 'Une erreur est survenue, veuillez reessayer.');
      }
    } catch(err){
          ...
          <form onSubmit={handleSubmit} style={{ padding: '2rem' }}>
            ...
            {step === 1 && (
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                ...
                {/* ✅ NOUVEAU : photo de profil (facultative) */}
                <div style={{ gridColumn: '1 / -1', display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', background: bgSurf, border: '1px solid ' + bdr, borderRadius: 12 }}>
                  ...
                  <div>
                    <div style={{ fontSize: '0.78rem', fontWeight: 700, color: ink }}>Photo de profil (facultative)</div>
                    <div style={{ fontSize: '0.68rem', color: muted, marginTop: 2 }}>JPG ou PNG, 2 Mo maximum</div>
                  </div>
                </div>
