...
function Register() {
  ...
  const villesMaroc = [
    ...
    'Settat', 'Taza', 'Essaouira', 'Larache', 'Tiznit', 'Ouarzazate', 'Dakhla', 'Guelmim',
    'Chefchaouen', 'Errachidia', 'Ifrane', 'Taroudant', 'Sidi Ifni', 'Berkane', 'Taourirt'
  ];

  const niveauxEtudes = [
    'Primaire', 'Collège', 'Lycée', 'Baccalauréat',
    'Licence 1', 'Licence 2', 'Licence 3', 'Master 1', 'Master 2', 'Doctorat',
    'Classes Préparatoires', 'BTS', 'DUT', 'Formation Continue', 'Autre'
  ];
  ...
  return (
    <div className="container d-flex flex-column align-items-center justify-content-center" style={{ minHeight: '100vh', padding: '24px' }}>
      ...
      <div className="card shadow rounded-4" style={{ maxWidth: '500px', width: '100%' }}>
            ...
            <div className="row g-2">
              ...
              <div className="col-md-6">
                ...
                <div className="input-group">
                  ...
                  <button type="button" className="btn btn-outline-secondary btn-sm" onClick={() => setShowPass(!showPass)}>
              ...
              <div className="col-md-6">
                ...
                <div className="input-group">
                  ...
                  <button type="button" className="btn btn-outline-secondary btn-sm" onClick={() => setShowPass2(!showPass2)}>
