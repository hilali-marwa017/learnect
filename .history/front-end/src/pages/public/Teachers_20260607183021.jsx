...
function Teachers() {
  ...
  const [maxTarif, setMaxTarif] = useState(500);
  ...
  const filterEnseignants = () => {
    ...
    // Filtre par matière - CORRECTION ICI
    if (searchMatiere) {
      filtered = filtered.filter(prof =>
        prof.matieres && prof.matieres.some(m => 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
            <div style={{ flex: 2, position: 'relative', minWidth: 200 }}>
              ...
              <input
                ...
                placeholder="Rechercher une matière (Maths, Physique...)"
                value={searchMatiere}
