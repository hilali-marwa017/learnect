      ...
      <div style={{display: 'flex',maxWidth: '1000px',width: '100%',background: 'white',borderRadius: '24px',boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.15)',overflow: 'hidden'}}>
        {/* Bouton retour */}
          <div className='fw-bold rounded-pill text-white text-decoration-none' >
            <Link to="/" 
              style={{display:'inline-flex',alignItems:'center',marginBottom: '20px' ,gap: '6px',color: 'black',textDecoration: 'none'}}><i className="bi bi-arrow-left"></i> Retour à l'accueil</Link>
          </div>
        {/* left part */}
