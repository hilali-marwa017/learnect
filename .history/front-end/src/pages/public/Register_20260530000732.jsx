...
function Register(props) {
  ...
  const goToStudentRegister = () => {
    console.log("Navigation vers inscription étudiant");
    props.onNavigate('register-student');
  };

  const goToTeacherRegister = () => {
    console.log("Navigation vers inscription enseignant");
    props.onNavigate('register-teacher');
  };
            ...
            <div className="card-body p-0 text-center">
              ...
              <div className="mb-5">
                ...
                <p className="text-muted mx-auto" style={{ maxWidth: '420px', fontSize: '15px' }}>
                  Choisissez votre profil pour commencer votre aventure
                </p>
              </div>
              ...
              <div className="row g-4 justify-content-center">
                ...
                <div className="col-md-6">
                  <div 
                    ...
                    className="border border-2 rounded-4 p-4 text-center transition-card option-card"
                  ...
                  >
                    ...
                    <h4 className="fw-bold text-dark mb-2" style={{ fontSize: '1.25rem' }}>Je suis élève</h4>
                    ...
                    <button 
                      className="btn btn-outline-dark w-100 py-2.5 fw-bold" 
                ...
                <div className="col-md-6">
                  <div 
                    onClick={goToTeacherRegister}
                    className="border border-2 rounded-4 p-4 text-center transition-card option-card-active"
                    style={{ borderColor: '#059669', background: 'rgba(5, 150, 105, 0.02)', cursor: 'pointer' }}
                  >
                    ...
                    <h4 className="fw-bold text-dark mb-2" style={{ fontSize: '1.25rem' }}>Je suis enseignant</h4>
                    <p className="text-muted small mb-4 px-2" style={{ minHeight: '40px', lineHeight: '1.4' }}>
                      Je souhaite proposer mes cours, gérer mes créneaux et développer mon activité.
                    </p>
                    <button 
                      className="btn btn-success w-100 py-2.5 fw-bold text-white border-0" 
                      style={{ borderRadius: '10px', fontSize: '14px', background: '#059669' }}
                    >
                      Donner des cours →
                    </button>
                  </div>
