...
import { Mail, Lock, Eye, EyeOff, GraduationCap, ArrowRight, X } from 'lucide-react';
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div style={{ width: '40px', height: '40px', background: leftIconBg, borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', background: bgRight }}>
          ...
          {/* Header X — même style que RegisterTeacher */}
