...
import { User, Mail, Lock, Phone, MapPin, GraduationCap, Wallet } from 'lucide-react'
          ...
          <form onSubmit={handleSubmit} style={{ padding: '2rem' }}>
            ...
            {step === 1 && (
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                <Field label="Prénom" icon={User} name="prenom" placeholder="Ex: Amine" />
                <Field label="Nom" icon={User} name="nom" placeholder="Ex: Benjelloun" />
                <Field label="Adresse Email" icon={Mail} name="email" type="email" placeholder="votre.email@domain.ma" />
                <Field label="Mot de passe" icon={Lock} name="password" type="password" placeholder="••••••••" />
                <Field label="Confirmer le mot de passe" icon={Lock} name="password_confirmation" type="password" placeholder="••••••••" />
                <Field label="Téléphone portable" icon={Phone} name="telephone" placeholder="Ex: +212 661-234567" />
