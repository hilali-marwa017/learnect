          ...
          {etape === 2 && (
            <form onSubmit={handleSubmit}>
              <div className="row g-3">
                ...
                <div className="col-12">
                  <label className="form-label small fw-semibold">Intitulé du diplôme</label>
                  <input type="text" name="diplomeTitle" className="form-control"
                    placeholder="Ex: Master en Mathématiques, Licence en Physique..."
                    value={formulaire.diplomeTitle} onChange={handleChange} required />
                </div>
