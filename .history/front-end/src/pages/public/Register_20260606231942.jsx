        ...
        <div className="card border-0 shadow-lg rounded-4 p-4" style={{ maxWidth: '400px', width: '100%' }}>
          ...
          <div className="bg-light rounded-3 p-3 mb-3">
            ...
            <div className="d-flex align-items-center gap-2">
              ...
              <span className="small">Validation sous 24h par l'administrateur</span>
            </div>
          </div>
        ...
        <div className="card-body p-4">
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-muted small">
              {role === 'enseignant' ? 'Partagez vos connaissances' : 'Trouvez votre professeur idéal'}
            </p>
          </div>
            ...
            <div className="row g-2">
              ...
              <div className="col-12">
                <label className="form-label small fw-semibold text-secondary mb-1">
                  <i className="bi bi-whatsapp me-1"></i> Téléphone
                </label>
                <input type="tel" name="telephone" className="form-control form-control-sm py-2" placeholder="+212 6XX XXX XXX" value={form.telephone} onChange={handleChange} required />
              </div>
              ...
              {role === 'etudiant' && (
                <>
                  ...
                  <div className="col-md-6">
                    ...
                    <input type="number" name="budget" className="form-control form-control-sm py-2" placeholder="Ex: 150" value={form.budget} onChange={handleChange} />
                  </div>
                </>
              )}
              ...
              {role === 'enseignant' && (
                <>
                  ...
                  <div className="col-md-4">
                    ...
                    <input type="number" name="tarifHeure" className="form-control form-control-sm py-2" min="50" placeholder="150" value={form.tarifHeure} onChange={handleChange} required />
                  </div>
                </>
              )}
                ...
                <div className="col-12">
                  <div className="bg-light rounded-3 p-3 mt-2">
                    ...
                    <div className="mt-2 p-2 bg-white rounded-3 d-flex gap-2">
                      ...
                      <small className="text-muted">Vérification sous 24h après soumission</small>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="col-12 mt-3">
                <div className="border rounded-3 p-2 bg-white d-flex align-items-center gap-2">
                  <input type="checkbox" id="certification" required style={{ width: '18px', height: '18px', accentColor: '#0d6efd' }} />
                  <label htmlFor="certification" className="small text-muted mb-0">Je certifie sur l'honneur l'exactitude des pièces fournies</label>
                </div>
              </div>
