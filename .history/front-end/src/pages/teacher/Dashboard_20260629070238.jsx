...
export default function TeacherDashboard() {
  ...
  // ✅ CORRIGÉ - Couleurs adaptées pour dark mode (violet plus clair)
                            ...
                            {r.statut === 'paiement_recu' && (
                              <>
                                <button
                                  ...
                                  disabled={!!isLoading}
                                  style={{ display: 'flex', alignItems: 'center', gap: '5px', padding: '7px 14px', borderRadius: '8px', border: '1px solid rgba(34,197,94,0.4)', background: 'rgba(34,197,94,0.15)', color: '#4ade80', fontSize: '0.72rem', fontWeight: 800, cursor: isLoading ? 'not-allowed' : 'pointer', fontFamily: 'monospace' }}>
                                ...
                                <button
                                  ...
                                  disabled={!!isLoading}
                                  style={{ display: 'flex', alignItems: 'center', gap: '5px', padding: '7px 14px', borderRadius: '8px', border: '1px solid rgba(220,38,38,0.3)', background: 'rgba(220,38,38,0.15)', color: '#f87171', fontSize: '0.72rem', fontWeight: 800, cursor: isLoading ? 'not-allowed' : 'pointer', fontFamily: 'monospace' }}>
                                  <XCircle size={13} />
            ...
            {activeSection === 'paiements' && (
              <div style={{ background: bgCard, border: '1px solid ' + border, borderRadius: '20px', padding: '1.5rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.25rem', paddingBottom: '1rem', borderBottom: '1px solid ' + borderSub }}>
                  ...
                  <div style={{ fontSize: '0.85rem', fontWeight: 800, color: '#4ade80' }}>
