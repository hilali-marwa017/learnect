        ...
        <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{ background: bgSurf, border: `1px solid ${border}`, borderRadius: '20px', padding: '1.5rem' }}>
              ...
              {saveSuccess && (
                <div style={{ padding: '10px 14px', background: 'rgba(34,197,94,0.08)', border: '1px solid rgba(34,197,94,0.2)', borderRadius: '10px', color: '#16a34a', fontSize: '0.75rem', fontWeight: 700, marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <Save size={14} /> Créneau ajouté avec succès.
                </div>
              )}
            ...
            <div style={{ background: bgCard, border: `1px solid ${border}`, borderRadius: '20px', padding: '1.5rem' }}>
              ...
              {loading ? (
                ...
                <div>
                  {JOURS.map((jour, i) => {
                    ...
                    return (
                      <div key={jour} style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '14px 0', borderBottom: i < JOURS.length - 1 ? `1px solid ${borderSub}` : 'none', flexWrap: 'wrap' }}>
              ...
              <div style={{ marginTop: '1.5rem', paddingTop: '1rem', borderTop: `1px solid ${borderSub}`, display: 'flex', justifyContent: 'flex-end' }}>
                <button
                  onClick={() => { setSaveSuccess(true); setTimeout(() => setSaveSuccess(false), 2500); }}
                  style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 24px', borderRadius: '12px', background: isDark ? '#ffffff' : '#111827', color: isDark ? '#111827' : '#ffffff', border: 'none', fontSize: '0.78rem', fontWeight: 800, cursor: 'pointer', fontFamily: 'monospace', letterSpacing: '0.06em' }}
                >
                  <Save size={16} /> METTRE A JOUR CALENDRIER
                </button>
              </div>
