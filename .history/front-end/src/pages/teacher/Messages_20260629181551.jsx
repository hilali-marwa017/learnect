...
export default function TeacherMessages() {
  ...
  useEffect(() => {
    ...
    async function fetchMessages() {
      try {
        // ✅ CORRIGÉ : URL avec /conversations/
        const responses = await Promise.all(
          activeConv.reservations.map(r => api.get(`/messages/conversations/${r.id_reservation}`))
        );
        ...
        await Promise.all(
          activeConv.reservations.map(r => api.put(`/messages/${r.id_reservation}/lu`).catch(() => {}))
        );
      } catch (e) {
        console.error(e);
      }
