...
// ✅ CORRECT - Import depuis le même dossier
...
export default function TeacherAvailability() {
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      setError(e.response?.data?.message || 'Erreur ajout.');
    } finally {
      setAdding(false);
    }
  }
  ...
  async function handleSaveEdit(id) {
    ...
    try {
      ...
      setError(e.response?.data?.message || 'Erreur modification.');
    } finally {
      setSaving(false);
    }
  }

  // Activer/Désactiver créneau
