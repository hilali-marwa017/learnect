          ...
          <div className="flex-grow space-y-8">
            ...
            <div className="bg-surface-card border border-hairline-strong rounded-2xl p-6 flex items-start gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-mute leading-relaxed font-semibold">Le premier entretien avec l'élève est toujours offert sur Learnect. Déterminez ensemble ses objectifs, évaluez ses points faibles et mettez en place un programme sur-mesure pour stimuler sa réussite.</p>
              </div>
            </div>
