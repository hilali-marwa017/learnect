            ...
            <div style={{ background: '#ffffff', border: '1px solid rgba(0,0,0,0.08)', borderRadius: '20px', padding: '1.5rem' }}>
              ...
              <div style={{ marginTop: '1.5rem', paddingTop: '1rem', borderTop: '1px solid rgba(0,0,0,0.06)', display: 'flex', justifyContent: 'flex-end' }}>
                <button
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 24px', borderRadius: '12px', background: '#111827', color: '#ffffff', border: 'none', fontSize: '0.78rem', fontWeight: 800, cursor: 'pointer', fontFamily: 'monospace', letterSpacing: '0.06em' }}
                >
              ...
              <div style={{ marginTop: '1rem' }}>
                <p style={{ fontSize: '0.7rem', color: '#9ca3af', fontFamily: 'monospace', margin: 0, display: 'flex', alignItems: 'center', gap: '6px' }}>
