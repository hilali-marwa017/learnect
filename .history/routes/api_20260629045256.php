...
Route::get('/enseignants/{id}/creneaux',     [CreneauController::class,   'getByEnseignant']);
Route::get('/enseignants/{id}/avis',         [AvisController::class,      'getByEnseignant']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('messages')->group(function () {
        ...
        Route::get('/conversations/enseignant',            [MessageController::class, 'mesConversationsEnseignant']); // ✅ AVANT {id_reservation}
    ...
    Route::middleware('role:enseignant')->group(function () {
        ...
        // ✅ Teacher accepte ou refuse après paiement reçu
        Route::put('/reservations/{id}/accepter', [ReservationController::class, 'accepterReservation']);
        Route::put('/reservations/{id}/refuser',  [ReservationController::class, 'refuserReservation']);
    ...
    Route::middleware('role:admin')->prefix('admin')->group(function () {
        ...
        Route::get('/users',                              [AdminController::class,      'users']); // ✅ minuscule
