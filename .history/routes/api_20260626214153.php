...
// ═══════════════════════════════════════════════════════════
// ROUTES PROTEGEES (auth:sanctum requis)
// ═══════════════════════════════════════════════════════════
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:etudiant')->group(function () {
        ...
        // Dashboard étudiant → GET /dashboard
        ...
        // Réservations étudiant → GET /reservations, POST /reservations, etc.
        ...
        // Offres reçues sur les demandes
    ...
    Route::middleware('role:enseignant')->group(function () {
        ...
        // Dashboard enseignant → GET /enseignant/dashboard (corrigé, était /teacher/dashboard)
        Route::prefix('enseignant')->group(function () {
            ...
            Route::get('/profil',            [EnseignantController::class, 'monProfil']);
            ...
            // alias /enseignant/profile (le frontend utilise 'profile' pas 'profil')
            Route::get('/enseignant/profile',  [EnseignantController::class, 'show']);
            Route::put('/enseignant/profile',  [EnseignantController::class, 'update']);


        });

        // Revenus enseignant → GET /paiements/enseignant/revenus
        Route::prefix('paiements')->group(function () {
            Route::get('/enseignant/revenus', [PaiementController::class, 'revenusEnseignant']);
            // revenus enseignant — le frontend appelle /teacher/revenus
    ...
    Route::middleware('role:admin')->prefix('admin')->group(function () {
        ...
        Route::put('/users/{user}/bloquSer',               [AdminController::class, 'bloquer']);
        ...
        Route::put('/enseignants/{enseignant}/valider',   [AdminController::class, 'validerEnseignant']);S
