...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('reservations', function (Blueprint $table) {
            ...
            $table->foreignId('id_creneau')->constrained('creneaux', 'id_creneau')->onDelete('cascade');
            $table->foreignId('id_offre')->nullable()->constrained('offres', 'id_offre')->onDelete('set null');
            $table->timestamps();
        });
    }
