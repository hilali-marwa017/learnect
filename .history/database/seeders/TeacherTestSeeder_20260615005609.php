...
class TeacherTestSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 4. Insertion des enseignants (UNIQUEMENT les colonnes qui existent)
        $enseignants = [
            [
        ...
        foreach ($enseigners as $enseigner) {
            DB::table('enseigners')->updateOrInsert(
                [
                    'id_enseignant' => $enseigner['id_enseignant'],
                    'id_matiere' => $enseigner['id_matiere']
                ],
                $enseigner
            );
        }
