...
class TeacherTestSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Insertion des enseignants - AVEC TOUTES LES COLONNES REQUISES
        ...
        // Pour la table pivot 'enseigners', utilisez 'utilisateur_id' au lieu de 'id_enseignant'
        DB::table('enseigners')->insert([
            ['utilisateur_id' => $sofiaId, 'id_matiere' => $mathsId, 'niveau' => 'Lycée'],
            ['utilisateur_id' => $karimId, 'id_matiere' => $physiqueId, 'niveau' => 'Lycée'],
            ['utilisateur_id' => $nadiaId, 'id_matiere' => $anglaisId, 'niveau' => 'Lycée'],
            ['utilisateur_id' => $nadiaId, 'id_matiere' => $francaisId, 'niveau' => 'Lycée'],
            ['utilisateur_id' => $youssefId, 'id_matiere' => $informatiqueId, 'niveau' => 'Université'],
        ]);
        ...
        echo "👤 Users enseignants: " . DB::table('users')->where('role', 'enseignant')->count() . "\n";
