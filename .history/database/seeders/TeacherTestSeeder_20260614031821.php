...
class TeacherTestSeeder extends Seeder
{
    public function run()
    {
        ...
        $user1 = DB::table('users')->insertGetId([
            'nom' => 'Benani',
            'prenom' => 'Sofia',
            'email' => 'sofia.benani@learnect.ma',  // Email unique
        ...
        DB::table('enseignants')->insert([
            ...
            'description_profil' => 'Ancienne élève de l\'ENS, je prépare les étudiants aux concours et examens nationaux avec une méthode éprouvée.',
            'description_cours' => 'Cours de mathématiques pour tous niveaux (Collège, Lycée, CPGE)',
            'tarifHeure' => 180,
            'estVerifie' => true,
            'noteMoyenne' => 4.8,
        ...
        // ========== ENSEIGNANT 2 - Amine Chraibi ==========
        $user2 = DB::table('users')->insertGetId([
            'nom' => 'Chraibi',
            'prenom' => 'Amine',
            'email' => 'amine.chraibi@learnect.ma',  // Email unique
            'password' => Hash::make('password123'),
        ...
        DB::table('enseignants')->insert([
            ...
            'titre' => 'Spécialiste en Physique-Chimie - Lycée & CPGE',
            'description_profil' => 'Diplômé de l\'Université Claude Bernard de Lyon, 10 ans d\'expérience en classes préparatoires.',
            'description_cours' => 'Cours de physique-chimie avec exercices types et préparation aux concours',
            'tarifHeure' => 200,
            'estVerifie' => true,
            'noteMoyenne' => 4.9,
            'statut_annonce' => 'en_ligne',
        ...
        // ========== ENSEIGNANT 3 - Leila Moukrim ==========
        $user3 = DB::table('users')->insertGetId([
            'nom' => 'Moukrim',
            'prenom' => 'Leila',
            'email' => 'leila.moukrim@learnect.ma',  // Email unique
            'password' => Hash::make('password123'),
        ...
        DB::table('enseignants')->insert([
            ...
            'titre' => 'Professeur Expérimentée de SVT - Terminale SMB & PC',
            'description_profil' => 'Passionnée par les sciences de la vie, j\'accompagne les élèves vers la réussite au Baccalauréat.',
            'description_cours' => 'Cours de SVT avec schémas, exercices et préparation au Bac',
            'tarifHeure' => 150,
            'estVerifie' => true,
            'noteMoyenne' => 5.0,
            'statut_annonce' => 'en_ligne',
