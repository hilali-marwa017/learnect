...
class TeacherTestSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Insertion des enseignants - AVEC TOUS LES CHAMPS REQUIS
        DB::table('enseignants')->insert([
            [
                ...
                'diplome_fichier' => 'diplome_100.pdf',
                'justificatif_domicile' => 'justificatif_100.jpg',
                'photo_profil' => 'photo_100.jpg',
            ...
            [
                ...
                'cin_recto' => 'cin_recto_default.jpg',
                'cin_verso' => 'cin_verso_default.jpg',
                'diplome_fichier' => 'diplome_101.pdf',
                'justificatif_domicile' => 'justificatif_101.jpg',
                'photo_profil' => 'photo_101.jpg',
                'statut_validation' => 'valide',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'cin_recto' => 'cin_recto_default.jpg',
                'cin_verso' => 'cin_verso_default.jpg',
                'diplome_fichier' => 'diplome_102.pdf',
                'justificatif_domicile' => 'justificatif_102.jpg',
                'photo_profil' => 'photo_102.jpg',
                'statut_validation' => 'valide',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'cin_recto' => 'cin_recto_default.jpg',
                'cin_verso' => 'cin_verso_default.jpg',
                'diplome_fichier' => 'diplome_103.pdf',
                'justificatif_domicile' => 'justificatif_103.jpg',
                'photo_profil' => 'photo_103.jpg',
                'statut_validation' => 'valide',
                'created_at' => now(),
                'updated_at' => now(),
            ],
