...
class TeacherTestSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('enseignants')->insert([
            ...
            'description_profil' => 'Ancienne élève de l\'ENS, préparation aux concours et examens nationaux',
        ...
        DB::table('enseignants')->insert([
            ...
            'description_profil' => '10 ans d\'expérience en classes préparatoires et lycée',
            'description_cours' => 'Cours de physique-chimie avec exercices types',
            'tarifHeure' => 200,
            'estVerifie' => true,
            'noteMoyenne' => 4.9,
            'statut_annonce' => 'en_ligne',
        ...
        DB::table('enseignants')->insert([
            ...
            'description_profil' => 'Passionnée par les sciences de la vie, accompagnement vers la réussite au Bac',
            'description_cours' => 'Cours de SVT avec schémas et exercices',
            'tarifHeure' => 150,
            'estVerifie' => true,
            'noteMoyenne' => 5.0,
            'statut_annonce' => 'en_ligne',
