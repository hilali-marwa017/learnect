...
class Enseignant extends Model
{
    ...
    protected $fillable = ['utilisateur_id','cin_recto'','diplome','titre','description_cours','description_profil','cours_domicile','cours_deplacement','cours_enligne','distance_max','langues','tarifHeure','estVerifie','noteMoyenne','statut_annonce'];
    ...
    public function matieres(){
        return $this->belongsToMany(Matiere::class,'enseigners','id_enseignant','id_matiere')->withPivot('niveau')->withTimestamps();
    }
