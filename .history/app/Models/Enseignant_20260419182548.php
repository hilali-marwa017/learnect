...
class Enseignant extends Model
{
    ...
    protected $fillable = [
        ...
        'cin',
        'diplome',
        'titre','description_cours','description_profil','cours_domicile','cours_deplacement','cours_enligne','distance_max','langues','tarifHeure','estVerifie','noteMoyenne','statut_annonce'];
