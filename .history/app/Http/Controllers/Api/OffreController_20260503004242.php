...
class OffreController extends Controller
{
    ...
    public function index($id_demande)
    {
        ...
        $offres = Offre::with('enseignant.user')->where('id_demande', $id_demande)
                       ->get();
    ...
    // Accepter une offre — ✅ avec vérif ownership
    public function accepter($id)
    {
        ...
        // ✅ CORRECTION : vérifier que c'est bien l'étudiant
