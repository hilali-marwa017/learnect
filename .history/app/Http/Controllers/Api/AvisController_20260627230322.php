...
class AvisController extends Controller
{
    ...
    public function index($id_enseignant){
        ...
        $avis = Avis::with('etudiant')->where('id_enseignant',$id_enseignant)->orderBy('created_at','desc')->get();

        return response()->json($avis);
    }

    // ✅ NOUVEAU : verifie si l'etudiant connecte peut laisser un avis a cet enseignant
    // et retourne la reservation terminee (non encore notee) la plus recente
    ...
    public function store(Request $request){
        ...
        // ✅ empeche de noter 2 fois la meme reservation
