...
class PaiementController extends Controller
{
    ...
    public function index(){
        $paiements = Paiement::with('reservation.creneau.enseignant.user')->join('reservations','paiements.id_reservation','=','reservations.id_reservation')->where('reservations.id_utilisateur',Auth::id())->select('paiements.*')
->get();
