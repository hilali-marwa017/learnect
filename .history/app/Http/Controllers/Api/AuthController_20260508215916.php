    ...
    public function register(Request $request)
    {
        ...
        if ($request->role === 'enseignant'){
            $request->validate([
                ...
                'diplome'   => 'required|image|mimes:jpg,jpeg,png,pdf|max:2048',
            ]);
        }
        ...
        $user = User::create([
            ...
            'email'     => $request->email,
            'password'  => $request->password, // ✅ casts hache auto
            'telephone' => $request->telephone,
            'ville'     => $request->ville,
            'role'      => $request->role,
            'statut'    => $request->role === 'enseignant'
                            ? 'en_attente' // admin doit valider
                            : 'actif',     // étudiant actif direct
            'can_learn' => true,
        ...
        // CREER PROFIL ENSEIGNANT + DOCUMENTS
            ...
            Enseignant::create([
                ...
                'cin_verso'      => $pathVerso,
                'diplome'        => $pathDiplome,
                'statut_annonce' => 'brouillon', // ✅ corrigé
            ]);
        }
