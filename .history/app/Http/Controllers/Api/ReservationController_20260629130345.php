...
class ReservationController extends Controller
{
    ...
    // Créer une réservation (étudiant)
    public function store(Request $request)
    {
        ...
        // ⚠️ BUG IDENTIFIÉ: Si la 1ère réservation existe mais est annulée, 
        // le prochain cours est payant. Choix délibéré du projet.
        ...
        // Toujours simulation, plus de cash
        Paiement::create([
    ...
    // Étudiant paie (simulation carte) → statut paiement = paye, statut reservation = paiement_recu
    public function confirmerPaiement($id)
    {
        ...
        // Reservation passe en "paiement_recu" — teacher doit accepter
        ...
        // Notif enseignant — il doit accepter ou refuser
        Notification::create([
            'type'          => 'paiement',
    ...
    // Teacher accepte la réservation après paiement reçu
    ...
    // Teacher refuse la réservation → remboursement simulé
    ...
    public function destroy($id)
    {
        ...
        // Si déjà payé → remboursement simulé
