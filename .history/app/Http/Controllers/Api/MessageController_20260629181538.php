...
class MessageController extends Controller
{
    ...
    // ✅ Liste des conversations pour l'enseignant connecte
    public function mesConversationsEnseignant(){
        $reservations = Reservation::with(['creneau.enseignant.user','etudiant','messages.expediteur'])
            ->where('statut','confirmee')
    ...
    // ✅ Recuperer les messages d'une reservation (GET /messages/conversations/{id_reservation})
    ...
    // ✅ Compter les messages non lus de user connecte
