...
{
    // liste des paiements de user connectee
    ...
    // ✅ CORRIGÉ : revenus de l'enseignant connectee avec eager loading
    public function revenusEnseignant(){
        // ✅ AJOUT : with('reservation.etudiant') pour charger les noms des étudiants
