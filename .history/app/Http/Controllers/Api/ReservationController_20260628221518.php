...
class ReservationController extends Controller
{
    ...
    // ✅ CORRIGE : vérification de l'heure avant de terminer le cours
    public function terminer($id)
    {
        ...
        // ✅ VÉRIFICATION : le cours ne peut être terminé qu'après l'heure de fin
        $heureFin = $reservation->creneau->heureFin;
        $dateCours = $reservation->date . ' ' . $heureFin;
        $dateFin = Carbon::parse($dateCours);
