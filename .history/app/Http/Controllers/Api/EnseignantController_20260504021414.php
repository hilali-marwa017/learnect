...
class EnseignantController extends Controller
{
    ...
    public function show($id){
        $enseignant = Enseignant::with('user', 'matieres', 'avis', 'creneaux', 'documents')->where('utilisateur_id',$id)->first();
    ...
    public function update(Request $request)
    {
        ...
        $enseignant->update($request->only(['titre', 'description_cours', 'description_profil','cours_domicile', 'cours_deplacement', 'cours_enligne',
