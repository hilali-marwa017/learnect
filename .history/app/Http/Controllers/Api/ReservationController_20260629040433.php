...
class ReservationController extends Controller
{
    ...
    // Étudiant paie (simulation carte) → statut paiement = paye, statut reservation = en_attente_acceptation
    // Le teacher doit ensuite accepter ou refuser
    ...
    // ✅ NOUVEAU — Teacher accepte la réservation après paiement reçu
    ...
    // ✅ NOUVEAU — Teacher refuse la réservation → remboursement simulé
