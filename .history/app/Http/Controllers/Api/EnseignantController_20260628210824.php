...
class EnseignantController extends Controller
{
    ...
    public function show($id){
        $enseignant = Enseignant::with('user', 'matieres', 'avis.etudiant', 'creneaux')->where('utilisateur_id',$id)->first();
    ...
    public function update(Request $request){
        $request->validate([
            'titre'=>'string|min:3',
            'description_cours'=>'string|min:10',
            'description_profil'=>'string|min:10',
