...
class EnseignantController extends Controller
{
    ...
    public function uplpoadPhoto(Request $request){
        ...
        public function uploadDocuments(Request $request){
            ...
            //recuperation d'image cin
            $fileRecto = $request->file('cin_recto');
            $nameRecto = 'cin_recto_' . Auth::id() . '_' . time() . '.' . $fileRecto->getClientOriginalExtension();
            $filenameCin = 'cin_' . Auth::id() . '_' . time() . '_' . $fileCin->getClientOriginalExtension();
            $enseignant->cin = $fileCin->storeAs('documents/cin',$filenameCin,'public');
