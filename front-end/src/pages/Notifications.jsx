        ...
        {loading ? <div style={{ textAlign: 'center', padding: '3rem', color: muted }}>Chargement...</div> : notifs.length === 0 ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {notifs.map(n => {
              ...
              return (
                <div key={n.id_notification} style={{ background: n.est_lue ? bgCard : (dark ? 'rgba(224,79,0,0.04)' : 'rgba(224,79,0,0.03)'), border: '1px solid ' + (n.est_lue ? border : 'rgba(224,79,0,0.15)'), borderRadius: '14px', padding: '1rem 1.25rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
